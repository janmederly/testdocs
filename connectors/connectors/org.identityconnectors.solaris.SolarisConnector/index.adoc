...
Yet there is a xref:/midpoint/reference/latest/diag/logging/[workaround for this]. Use the following line in `logging.properties` file to enable Expect4j logging:
