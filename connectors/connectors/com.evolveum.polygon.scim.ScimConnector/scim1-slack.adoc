...
Before test connection, please xref:/midpoint/reference/latest/security/crypto/ssl-connections-client-side-/[import certificate] to midPoint Keystore.
...
* xref:/midpoint/reference/latest/security/crypto/ssl-connections-client-side-/[SSL Connection (Client Side)]
