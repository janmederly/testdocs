...
If not working, please check if you already set up xref:/midpoint/reference/latest/security/crypto/keystore-configuration/[javax.net.ssl.trustStore to midPoint keystore].
