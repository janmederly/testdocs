...
To xref:/midpoint/reference/latest/repository/generic/configuration/#data-source-configuration[configure datasource in Tomcat], you can use the step 1 as when configuring midPoint repository (modification of server.xml and context.xml).
