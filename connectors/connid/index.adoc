...
E.g. midPoint xref:/midpoint/reference/latest/expressions/mappings/[mappings] copies and transforms attribute values, midPoint handles resource capabilities, xref:/midpoint/reference/latest/synchronization/[synchronization], etc.
