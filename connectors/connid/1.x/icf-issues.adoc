...
MidPoint is using xref:/midpoint/reference/latest/resources/connid/[ConnId connector framework] as a basic framework to support xref:/connectors/connectors/[identity connectors].
