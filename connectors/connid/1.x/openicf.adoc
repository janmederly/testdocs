...
MidPoint is fully migrated to xref:/midpoint/reference/latest/resources/connid/[ConnId] framework and Evolveum is an active contributor to the xref:/midpoint/reference/latest/resources/connid/[ConnId project].
====
...
OpenICF used to be compatible with xref:/midpoint/reference/latest/resources/connid/[ConnId framework], it is sharing the same architecture, concepts and significant part of the code base.
But there are some unilateral code changes made by ForgeRock that made the connectors incompatible.
Please refer to the xref:/midpoint/reference/latest/resources/connid/[ConnId] and xref:/connectors/connectors/[Identity Connectors] pages for more details.
...
These issues are addressed as a joint effort of several companies in cooperation with the xref:/midpoint/reference/latest/resources/connid/[ConnId project].
