...
Narrow table - we dont want to use 100% of width.
Also we want to keep order of rows at initialization.
...
Narrow table - we dont want to use 100% of width with search
