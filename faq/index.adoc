...
It allows very complex transformation and replication rules including support for advanced xref:/midpoint/reference/latest/roles-policies/rbac/[RBAC], xref:/midpoint/reference/latest/expressions/mappings/[data mappings], xref:/midpoint/reference/latest/org/organizational-structure/[organizational structure management] and xref:/iam/iga/what-is-identity-governance/[identity governance].
...
There is a xref:/midpoint/reference/latest/interfaces/rest/[RESTful service] that can be used to build completely custom user interfaces.

=== What services midPoint provides?

MidPoint provides a xref:/midpoint/reference/latest/interfaces/rest/[RESTful service] for the vital provisioning functions.
...
See xref:/midpoint/reference/latest/security/credentials/initial-password-management-discussion/[Initial Password Management Discussion page] for more detailed discussion of the topic.
...
See xref:/midpoint/reference/latest/security/authentication/flexible-authentication/[Flexible Authentication] for more details.
...
Please see xref:/midpoint/reference/latest/security/authentication/flexible-authentication/[Flexible Authentication] for more details.
...
MidPoint has something that is much better than generic objects: xref:/midpoint/reference/latest/schema/archetypes/[Archetypes].

See xref:/midpoint/reference/latest/schema/generic-objects/[Generic Objects] and xref:/midpoint/reference/latest/schema/archetypes/[Archetypes] pages for the details.
...
For more please see xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[midPoint Home directory].
...
* RESTful service: xref:/midpoint/reference/latest/interfaces/rest/[REST API]
* Local Java API: xref:/midpoint/reference/latest/interfaces/model-java/[IDM Model Interface]
...
Here: xref:/midpoint/reference/latest/interfaces/rest/[RESTful service]

=== I want to use the SOAP-based web service interface. Where do I start?

Don't. SOAP interface was removed in midPoint 4.2. Please use xref:/midpoint/reference/latest/interfaces/rest/[RESTful service] instead.
