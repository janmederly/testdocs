...
Description of consistency mechanism which is practically used in midPoint can be found in the section xref:/midpoint/reference/latest/synchronization/consistency/[Consistency Mechanism].