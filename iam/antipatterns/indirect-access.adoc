...
However, some IDM systems (such as xref:/midpoint/reference/latest/resources/manual/configuration/[midPoint]) provide ability to use _semi-manual_ connectors.
