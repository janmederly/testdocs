...
* Classpath scan scope for UI panels. Narrowed to `com.evolveum.midpoint` by default. It can be changed via configuration property. See more xref:/midpoint/reference/latest/admin-gui/admin-gui-config[here].
