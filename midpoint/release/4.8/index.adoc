...
* xref:/midpoint/reference/latest/roles-policies/mining/[Role Mining].
...
xref:/midpoint/reference/latest/deployment/ninja/#role-mining-exportimport[Ninja documentation].
** Repository object (GUI): For detailed information, see the
xref:/midpoint/reference/latest/roles-policies/mining/anonymous-data-export/#anonymous-export-of-role-mining-data[Anonymous Export of Role Mining Data documentation].
...
For more info see: xref:/midpoint/reference/latest/security/audit/index.adoc[Auditing]
...
* Generic Repository with PostgreSQL is not supported, if you are using PostgreSQL with generic repository, please migrate to xref:/midpoint/reference/latest/repository/native-postgresql/[PostgreSQL native repository].
