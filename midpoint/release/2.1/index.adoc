...
* xref:/midpoint/reference/latest/security/audit/#database-table-auditing[SQL table][Auditing to SQL tables] (see also xref:/midpoint/reference/latest/security/audit/[basic information about auditing])
...
* Improved attribute xref:/midpoint/reference/latest/expressions/[mappings and expressions]

* xref:/midpoint/reference/latest/expressions/mappings/[Support for conditions in attribute mappings] (roles, outbound/inbound mapping)

* Experimental xref:/midpoint/reference/latest/cases/workflow-3/[workflow integration]
