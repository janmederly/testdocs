...
* xref:/midpoint/reference/latest/security/audit/#database-table-auditing[Auditing to SQL tables] (see also xref:/midpoint/reference/latest/security/audit/[basic information about auditing])
