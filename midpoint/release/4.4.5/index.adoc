...
* Post-registration form (invitation form) requires Nonce authorization, see xref:/midpoint/reference/latest/misc/self-registration/configuration-before-4-6/[Self Registration configuration before 4.6] for proper configuration and link generation.
