...
** xref:/midpoint/reference/latest/misc/reports/configuration/#new-report[Native reports] (a.k.a. "Jasper-less reports")
...
** xref:/midpoint/reference/latest/misc/reports/configuration/#import-report[Custom data imports] (a.k.a. "reverse reports") (experimental)
...
** xref:/midpoint/reference/latest/resources/maintenance-state/[Resource maintenance mode (contributed)]

** xref:/midpoint/reference/latest/resources/multiaccounts/#outbound-mappings[Outbound multiaccounts]

** xref:/midpoint/reference/latest/synchronization/linked-objects/[Linked objects]

** xref:/midpoint/reference/latest/roles-policies/role-autoassignment/configuration/[Restriction of autoassignment mappings to a given focus type(s)]

** xref:/midpoint/reference/latest/schema/archetypes/configuration/#multiple-archetypes[Support for multiple archetypes]
...
** xref:/midpoint/reference/latest/security/authentication/flexible-authentication/configuration/[Authentication policy for node group]

** xref:/midpoint/reference/latest/misc/reports/configuration/[Expression profiles for GUI/report column expressions]



* Internals and Development

** xref:/midpoint/reference/latest/security/audit/#separate-repository-configuration-for-audit[Decoupling of audit and repository databases]
...
Those databases will be supported for some time (possibly long time), but xref:/midpoint/reference/latest/repository/repository-database-support/[support for them will be eventually removed]. It is strongly recommended to use PostgreSQL instead.
...
Therefore xref:/midpoint/reference/latest/upgrade/database-schema-upgrade/[the usual upgrade mechanism] can be used.
There are some important changes to keep in mind:

* Database schema needs to be upgraded using the xref:/midpoint/reference/latest/upgrade/database-schema-upgrade/[usual mechanism].
...
* xref:/midpoint/reference/latest/legacy/soap/[IDM Model Web Service Interface] (SOAP) was removed.
