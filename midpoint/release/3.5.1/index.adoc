...
** Experimental support for xref:/midpoint/reference/latest/roles-policies/policy-rules/[policy rules]
...
** Pre-configured xref:/midpoint/reference/latest/cases/approval/[Approval] processes
...
* Improved xref:/midpoint/reference/latest/cases/approval/[approval] processes
...
MidPoint 3.5 data model is essentially backwards compatible with both midPoint 3.4 and midPoint 3.4.1. However as the data model was extended in 3.5 the database schema needs to be upgraded using the xref:/midpoint/reference/latest/upgrade/database-schema-upgrade/[usual mechanism].
