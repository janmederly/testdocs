...
Create xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[midPoint home directory]. This directory contains midpoint startup configuration, keystore, connector code and similar things.
...
See xref:/midpoint/reference/latest/security/crypto/[Encryption and Keys] and xref:/midpoint/reference/latest/security/crypto/keystore-configuration/[Keystore Configuration] pages for more information.
