...
Midpoint provides multiple mechanisms to xref:/midpoint/reference/latest/concepts/query/[query] data. This document provides basic information of xref:/midpoint/reference/latest/concepts/query/axiom-query-language/[AXIOM query language] and examples of its usage in midPoint GUI.
...
More detail information and description of the operators can be found at xref:/midpoint/reference/latest/concepts/query/axiom-query-language/[Axiom Query Language] documentation.
...
Note: For detail explanation of the query please check additional xref:/midpoint/reference/latest/concepts/query/axiom-query-language/examples/[Example AXIOM queries] page.
...
- xref:/midpoint/reference/latest/concepts/query/[midPoint Query] - Query concepts in midPoint
- xref:/midpoint/reference/latest/concepts/query/axiom-query-language/[Axiom Query Language] - Main page of AXIOM query language.
- xref:/midpoint/reference/latest/concepts/query/axiom-query-language/examples/[Example Axiom Queries] - Additional examples with more detail explanation.
- xref:/midpoint/reference/latest/concepts/query/axiom-query-language/expressions/[Expressions in Axiom Query] - Expressions in AXIOM queries.
