...
NOTE: Don't confuse the Report task with xref:/midpoint/reference/latest/tasks/synchronization-tasks/asynchronous-update[Asynchronous update task] which is used for updating data from resources.
...
- xref:/midpoint/reference/latest/admin-gui/dashboards/[] - main info about dashboards
- xref:/midpoint/reference/latest/admin-gui/dashboards/configuration/[] - details of dashboard configuration
- xref:/midpoint/reference/latest/misc/reports/configuration/[Report Configuration] - details of reports configuration
- xref:/midpoint/reference/latest/misc/reports/examples/example-report-number-of-members/[Example of Dashboard Report:Number of members] - more complex example of dashboard and dashboard report