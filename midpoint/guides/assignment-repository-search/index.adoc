...
For additional existing assignment panels and their GUI configuration see xref:/midpoint/reference/latest/admin-gui/admin-gui-config/[Admin GUI Configuration].
...
xref:/midpoint/reference/latest/repository/full-text-search/[Full-Text Search] for details.
...
NOTE: You can learn more about filters and dereferencing in xref:/midpoint/reference/latest/concepts/query/[Query Documentation].
