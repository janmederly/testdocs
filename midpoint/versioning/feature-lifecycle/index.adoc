...
MidPoint xref:/midpoint/reference/latest/deployment/ninja/[ninja] tool can be used to check whether your configuration is using deprecated functionality.
...
Once again, xref:/midpoint/reference/latest/deployment/ninja/[ninja] tool can be used to check whether your system is using configuration that is planned for removal.
