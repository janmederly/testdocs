...
As this is part of xref:/midpoint/reference/latest/admin-gui/admin-gui-config/[adminGuiConfiguration], it may be in the `System configuration` object or in roles/organizations assigned to the users.
