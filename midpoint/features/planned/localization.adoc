...
MidPoint 4.0 have some mechanism to deal with data localization, such as xref:/midpoint/reference/latest/concepts/polystring/[PolyString]. PolyString was part of midPoint design almost from the beginning.
