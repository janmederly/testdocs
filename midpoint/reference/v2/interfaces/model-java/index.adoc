...
*Stability:* STABLE +
*Platform:* Java +
*Dependencies:* xref:/midpoint/reference/v2/schema/[Data Model], Common schema +
...
See xref:/midpoint/reference/v2/legacy/soap/[IDM Model Web Service Interface] for description.
...
| 0.1
| September 2011
| Initial version derived from xref:/midpoint/reference/v2/legacy/soap/[IDM Model Web Service Interface]
| Radovan Semancik
