...
MidPoint xref:/midpoint/reference/v2/schema/[Data Model] specifies how the objects look like, what properties and containers they have, what are the types and multiplicities of the data and so on.
...
These types can be further specified by using xref:/midpoint/reference/v2/schema/archetypes/[archetypes].
...
* xref:/midpoint/reference/v2/schema/archetypes/[]