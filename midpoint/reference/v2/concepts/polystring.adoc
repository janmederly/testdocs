...
See xref:/midpoint/reference/v2/schema/polystring-normalization/[PolyString Normalization Configuration] page for more details.
...
* xref:/midpoint/reference/v2/schema/polystring-normalization/[PolyString Normalization Configuration]
