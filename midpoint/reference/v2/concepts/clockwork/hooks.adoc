...
Hooks are invoked by xref:/midpoint/reference/v2/concepts/clockwork/clockwork-and-projector/[Clockwork] component at appropriate stages of midPoint computation.

Hooks are typically pieces of Java code that has to be compiled and assembled into midPoint.
However there is also a lightweight way to xref:/midpoint/reference/v2/concepts/clockwork/scripting-hooks/[create a hook using a scripting code].


== See Also

* xref:/midpoint/reference/v2/concepts/clockwork/scripting-hooks/[Scripting Hooks]
