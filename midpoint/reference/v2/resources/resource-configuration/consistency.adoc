...
The `consistency` section of xref:/midpoint/reference/v2/resources/resource-configuration/[Resource Configuration] contains configuration of various data consistency mechanisms and features.
...
MidPoint usually operates in a xref:/midpoint/reference/v2/concepts/relativity/[relative] way.
