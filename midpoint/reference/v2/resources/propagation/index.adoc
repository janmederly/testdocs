...
And then there is a broad class of xref:/midpoint/reference/v2/resources/manual/[manual resources]. Both cases have one thing in common: resource operations are expensive.
