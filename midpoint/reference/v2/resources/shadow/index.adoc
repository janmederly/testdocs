...
User and all owned accounts are xref:/midpoint/reference/v2/synchronization/introduction/[synchronized] using xref:/midpoint/reference/v2/expressions/mappings/inbound-mapping/[inbound] and xref:/midpoint/reference/v2/expressions/mappings/outbound-mapping/[outbound] expressions.
...
See the xref:/midpoint/reference/v2/resources/resource-schema/[Resource Schema] page for more details.
...
Following example shows the same object but represented as resource object using xref:/midpoint/reference/v2/resources/resource-schema/[Resource Schema]. This is really not a typical example, it is provided here only for comparison with the shadow object.
...
The connector will announce the identification mechanism in the xref:/midpoint/reference/v2/resources/resource-schema/[Resource Schema] using the xref:/midpoint/reference/v2/resources/resource-schema/[Resource Schema Annotations].
...
* xref:/midpoint/reference/v2/resources/resource-schema/[]
