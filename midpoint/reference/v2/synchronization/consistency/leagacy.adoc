...
Please see the xref:/iam/idm-consistency/[IDM Consistency] page for short introduction to one of the consistency issues and xref:/midpoint/reference/v2/synchronization/consistency/theory/[Consistency Theory] for an theoretical introduction to the consistency problem.
...
xref:/midpoint/reference/v2/synchronization/introduction/[Reconciliation process] (also called synchronization) is a standard way how identity management systems solve possible inconsistencies.
...
Consistency mechanism was significantly improved in midPoint 3.9. Please see xref:/midpoint/reference/v2/synchronization/consistency/[Consistency mechanism] page for up-to-date information.
