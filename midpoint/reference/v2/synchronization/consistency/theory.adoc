...
Another important concept for the proposed mechanism is a xref:/midpoint/reference/v2/concepts/relativity/[relative change model]. Relative change model is used to describe changes made to the objects.
