...
This is somewhat similar to the known xref:/midpoint/reference/v2/tasks/specific/focus-validity-scan.adoc#_limitations[limitation of Focus Validity Scan activity].]
