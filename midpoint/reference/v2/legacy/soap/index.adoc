...
:page-replaced-by: /midpoint/reference/v2/interfaces/rest/
...
For a full-featured native java interface please see the xref:/midpoint/reference/v2/interfaces/model-java/[IDM Model Interface].
