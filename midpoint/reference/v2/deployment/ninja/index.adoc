...
Bundled scripts will automatically fill in path to for xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[midPoint home]
...
Check also the xref:/midpoint/reference/v2/repository/native-audit/#audit-migration-from-other-database[migration guide for the Native audit].
...
xref:/midpoint/reference/v2/roles-policies/mining/anonymous-data-export/#anonymous-export-of-role-mining-data[Anonymous Export of Role Mining Data].
