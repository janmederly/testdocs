...
This is distinct from xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[midPoint home directory],
...
| `var`
| Default xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[midPoint home directory], also known as `midpoint.home`.
Initial configuration, cryptographic keys, log files and similar "variable" content.
| Read-write
| See xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[MidPoint Home Directory].
...
The database files will be stored in xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[midPoint home directory].

The database can later be changed to a full-scale database engine.
The xref:/midpoint/reference/v2/repository/configuration/[Repository Configuration] page provides the instructions.
