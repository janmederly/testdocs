...
MidPoint is often deployed as a xref:/midpoint/reference/v2/deployment/stand-alone-deployment/[stand-alone server] with an embedded Apache Tomcat container.
