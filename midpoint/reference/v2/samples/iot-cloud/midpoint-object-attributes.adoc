...
We had to provide a connector implementation for ThingSpeak, described on a xref:/midpoint/reference/v2/samples/iot-cloud/thingspeak-resource/[separate page].
