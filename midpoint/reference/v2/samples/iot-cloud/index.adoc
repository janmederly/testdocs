...
For detailed description of key distribution please see xref:/midpoint/reference/v2/samples/iot-cloud/key-distribution-description/[this page].
...
Their attributes are described xref:/midpoint/reference/v2/samples/iot-cloud/midpoint-object-attributes/[on a separate page].
