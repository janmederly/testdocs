...
First of all please make sure you go through xref:/midpoint/reference/v2/diag/troubleshooting/usual-troubleshooting-steps/[Usual Troubleshooting Steps] to understand what is going on.
...
* Relevant part of the *log files*. You may want to have a look at xref:/midpoint/reference/v2/diag/logging/useful-loggers/[Useful Loggers] to correctly set up your logging to get the most useful data in the logs.
...
* xref:/midpoint/reference/v2/diag/troubleshooting/[]
