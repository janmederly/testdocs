...
* Adding `logback.xml` file in xref:/midpoint/reference/v2/deployment/midpoint-home-directory/[MidPoint Home Directory].
...
This logging is configured in the xref:/midpoint/reference/v2/concepts/system-configuration-object/[system
...
* xref:/midpoint/reference/v2/deployment/syslog-logging/[Syslog Logging]
