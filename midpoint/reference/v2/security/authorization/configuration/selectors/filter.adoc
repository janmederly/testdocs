...
xref:/midpoint/reference/v2/expressions/expressions/[Expressions] can be used in authorization search filters:
...
If you need complex computation, it is perhaps better to compute the value in xref:/midpoint/reference/v2/expressions/object-template/[object template] and place it into property of the object (e.g. user extension property).
