...
Java security modules are using a _truststore_ mechanism which is closely related to xref:/midpoint/reference/v2/security/crypto/keystore-configuration/[keystore]. The truststore is a small database of trusted certificates.
...
See xref:/midpoint/reference/v2/security/crypto/keystore-configuration/[Keystore Configuration] page for more details.
