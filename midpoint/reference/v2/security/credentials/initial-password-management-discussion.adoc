...
However, the design and the basic building stones are already in place (see xref:/midpoint/reference/v2/security/credentials/password-reset/new-configuration/[New Password Reset Configuration] for details).
...
E.g. midPoint can make sure that password for administrator xref:/midpoint/reference/v2/misc/persona/[persona] is not the same as the password for ordinary employee persona.
...
See xref:/midpoint/reference/v2/security/credentials/password-reset/new-configuration/[New Password Reset Configuration] page for details.
All that is needed to complete the functionality is motivation from midPoint subscribers.


== See Also

* xref:/midpoint/reference/v2/security/credentials/password-reset/[Reset Password Configuration]

* xref:/midpoint/reference/v2/security/credentials/password-reset/new-configuration/[New Password Reset Configuration]