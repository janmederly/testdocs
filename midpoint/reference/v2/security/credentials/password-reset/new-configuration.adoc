...
The old xref:/midpoint/reference/v2/security/credentials/password-reset/[Reset Password Configuration] is a very limited and somehow non-systemic feature.
...
This change need to be reflected to the interfaces as well (xref:/midpoint/reference/v2/interfaces/model-java/[IDM Model Interface], xref:/midpoint/reference/v2/interfaces/rest/[REST API]). There needs to be several new methods:
...
* xref:/midpoint/reference/v2/security/credentials/password-reset/[Reset Password Configuration] (old configuration, soon to be deprecated)