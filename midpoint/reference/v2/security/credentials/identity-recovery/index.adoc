...
processed with the help of xref:/midpoint/reference/v2/correlation/[correlation mechanism] and as a result one or multiple
...
xref:/midpoint/reference/v2/security/security-policy/[security policy merging] documentation.
...
about self registration flow configuration you can find by the xref:/midpoint/reference/v2/misc/self-registration/[link].
