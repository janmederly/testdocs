...
It can be also configured as a part of your xref:/midpoint/reference/v2/legacy/sso/[SSO] solution.
...
Unless midPoint is a part of a xref:/midpoint/reference/v2/legacy/sso/midpoint-as-cas-client-java-jasig-cas-client-libraries-/[CAS SSO solution], no modifications are needed to this file.
...
* xref:/midpoint/reference/v2/legacy/sso/midpoint-as-cas-client-apache-cas-agent-method-/[MidPoint as CAS Client (Apache CAS Agent Method)]

* xref:/midpoint/reference/v2/legacy/sso/midpoint-as-cas-client-java-jasig-cas-client-libraries-/[MidPoint as CAS Client (Java Jasig CAS Client libraries)]