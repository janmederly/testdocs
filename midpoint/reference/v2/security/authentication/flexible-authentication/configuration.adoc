...
Flexible authentication is configured in xref:/midpoint/reference/v2/security/security-policy[Security Policy]. Security policy can be defined on different levels.
