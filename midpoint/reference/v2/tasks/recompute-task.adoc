...
At the first sight recompute does almost the same job as xref:/midpoint/reference/v2/tasks/synchronization-tasks/[reconciliation].
...
This can be used to control whether the recompute process triggers reconciliation, what particular parts of the xref:/midpoint/reference/v2/concepts/clockwork/clockwork-and-projector/[clockwork and projector computation] will take place and so on.
...
* xref:/midpoint/reference/v2/tasks/synchronization-tasks/[Synchronization Tasks]
