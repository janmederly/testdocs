...
For details see related section in https://docs.evolveum.com/midpoint/reference/v2/repository/native-postgresql/postgresql-configuration/#connections[PostgreSQL Configuration].
...
For more information how to set up task manager for a cluster, please see xref:/midpoint/reference/v2/deployment/clustering-ha/[this article].
