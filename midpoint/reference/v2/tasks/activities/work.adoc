...
| xref:/midpoint/reference/v2/tasks/synchronization-tasks/import-and-reconciliation/[`import`]
...
| xref:/midpoint/reference/v2/tasks/synchronization-tasks/import-and-reconciliation/[`reconciliation`]
...
| xref:/midpoint/reference/v2/tasks/synchronization-tasks/asynchronous-update/[`asynchronousUpdate`]
...
.3+| xref:/midpoint/reference/v2/tasks/synchronization-tasks/live-synchronization/[`liveSynchronization`]
...
| This is obligatory parameter.
| `batchSize`
| See xref:/midpoint/reference/v2/tasks/synchronization-tasks/live-synchronization/[].
| 0
...
.3+| xref:/midpoint/reference/v2/tasks/specific/focus-validity-scan/[`focusValidityScan`]
...
| link:https://docs.evolveum.com/midpoint/reference/v2/tasks/shadow-refresh-task/[`shadowRefresh`]
...
.5+| xref:/midpoint/reference/v2/resources/shadow/integrity-check/[`shadowIntegrityCheck`]
...
.4+| xref:/midpoint/reference/v2/tasks/auto-scaling/[`activityAutoScaling`]
...
| xref:/midpoint/reference/v2/resources/propagation/configuration/[`propagation`]
...
| xref:/midpoint/reference/v2/resources/propagation/configuration/[`multiPropagation`]
