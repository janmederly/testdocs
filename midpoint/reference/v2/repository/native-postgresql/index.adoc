...
the differences are mentioned in the xref:/midpoint/reference/v2/concepts/query/[midPoint Query] document;
...
* supports xref:/midpoint/reference/v2/repository/native-audit/#partitioning[audit table partitioning];
