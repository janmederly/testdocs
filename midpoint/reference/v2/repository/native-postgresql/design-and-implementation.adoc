...
xref:/midpoint/reference/v2/schema/custom-schema-extension/[schema extensions].
...
In theory, xref:/midpoint/reference/v2/concepts/relativity/[relativity of midPoint] means that modifications
