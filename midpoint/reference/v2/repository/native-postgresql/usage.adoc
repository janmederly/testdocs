...
Read xref:/midpoint/reference/v2/repository/configuration/[Repository Configuration] for more information,
...
See xref:/midpoint/reference/v2/repository/native-audit[Native PostgreSQL Audit Trail] for details how
to set it up in a database xref:/midpoint/reference/v2/repository/native-audit/#sql-audit-using-its-own-database[separate from the main repository].
...
set the ID sequence in the new database as described in xref:/midpoint/reference/v2/repository/native-audit/#audit-migration-from-other-database[Audit migration from other database].
...
See xref:/midpoint/reference/v2/tasks/task-manager/configuration/[Task Manager Configuration]
for further details.
...
in xref:/midpoint/reference/v2/repository/configuration/[Repository Configuration] article.
...
* In case of error or exception, always include the relevant portion of the xref:/midpoint/reference/v2/diag/logging/[midpoint.log] in the report.
* Review xref:/midpoint/reference/v2/repository/native-postgresql/db-maintenance/#index-tuning[Index tuning]
...
`pg_stat_statements` extension as xref:/midpoint/reference/v2/repository/native-postgresql/db-maintenance/#monitoring-queries[described here].
* To log issued SQL queries in xref:/midpoint/reference/v2/diag/logging/[midpoint.log],
...
* xref:/midpoint/reference/v2/repository/repository-database-support/[Repository Database Support]
