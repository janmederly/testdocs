...
* Check the xref:/midpoint/reference/v2/deployment/clustering-ha/[Clustering / high availability setup]
...
See xref:/midpoint/reference/v2/repository/native-postgresql/postgresql-configuration/#connections[PostgreSQL Configuration] for more tips.
...
xref:/midpoint/reference/v2/tasks/task-manager/configuration/[Task Manager] and
xref:/midpoint/reference/v2/repository/native-audit/#sql-audit-using-its-own-database[dedicated SQL Audit DB].
