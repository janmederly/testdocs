...
* xref:/midpoint/reference/v2/repository/native-postgresql/[Native PostgreSQL repository]

* xref:/midpoint/reference/v2/repository/generic/[Generic repository implementation] - not recommended from 4.4 on
