...
Let us consider the example mentioned xref:/midpoint/reference/v2/roles-policies/assignment/using-assignment-path-in-expressions/[here] (copied here for simplicity):
