...
:page-moved-from: /midpoint/reference/v2/expressions/introduction/
...
Mappings are the "brain" of all xref:/midpoint/reference/v2/synchronization/[synchronization functions], they are used in xref:/midpoint/reference/v2/roles-policies/rbac/[role structures] and xref:/midpoint/reference/v2/expressions/object-template/[object templates], they are everywhere.
...
Therefore maintaining the xref:/midpoint/reference/v2/concepts/relativity/[relative change model] through the entire midPoint system.
...
It is used e.g. in xref:/midpoint/reference/v2/expressions/mappings/outbound-mapping/[outbound mappings], xref:/midpoint/reference/v2/expressions/mappings/inbound-mapping/[inbound mappings], xref:/midpoint/reference/v2/roles-policies/assignment/[assignments], xref:/midpoint/reference/v2/roles-policies/rbac/[roles],
  xref:/midpoint/reference/v2/expressions/object-template/[object templates] and so on.

See xref:/midpoint/reference/v2/expressions/mappings/[Mapping] page for more details.
...
Expression is often part of a mapping, it can be used in xref:/midpoint/reference/v2/synchronization/correlation-and-confirmation-expressions/[correlation and confirmation expressions], and for many other purposes.
