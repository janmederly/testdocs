...
It also contains version of xref:/midpoint/reference/v2/interfaces/model-java/[IDM Model Interface] methods that are designed to be easy to use from the scripting languages.

== IDM Model Interface Functions

Following functions directly invoke the operations of xref:/midpoint/reference/v2/interfaces/model-java/[IDM Model Interface].The library provides a simplified versions of the operations which are easier to use from scripts.
...
You may want to have a look at xref:/midpoint/reference/v2/interfaces/model-java/introduction/[IDM Model Interface Introduction] to see examples how to use these methods.
