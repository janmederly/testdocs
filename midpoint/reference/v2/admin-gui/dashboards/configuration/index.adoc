...
- xref:/midpoint/reference/v2/admin-gui/dashboards/[Customizable Dashboards] page provides basic information about this feature.
...
You can see basic configuration for objectCollection on xref:/midpoint/reference/v2/admin-gui/collections-views/configuration/#object-collection[Object Collection].
