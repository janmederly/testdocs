...
* xref:/midpoint/reference/v2/misc/self-registration/[Configuring self-registraion]

* xref:/midpoint/reference/v2/security/credentials/password-reset/[Configuring reset password]
