...
E.g. views can adjusted and overridden in xref:/midpoint/reference/v2/admin-gui/admin-gui-config/[admin GUI configuration].
...
* xref:/midpoint/reference/v2/admin-gui/collections-views/configuration/[Object Collections and Views Configuration]
