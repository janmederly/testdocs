...
The plan is that collections can be used in the entire midPoint system, e.g. collections can be used in xref:/midpoint/reference/v2/security/authorization/[authorizations], xref:/midpoint/reference/v2/roles-policies/policy-rules/[policy rules] may be applied to them and so on.
Some midPoint objects can act as an implicit collections, especially xref:/midpoint/reference/v2/schema/archetypes/[archetypes] and xref:/midpoint/reference/v2/org/organizational-structure/[organizational units]. Object collections are designed to be solid and stable.
...
E.g. views can be adjusted and overridden in xref:/midpoint/reference/v2/admin-gui/admin-gui-config/[admin GUI configuration].
...
E.g. It would be nice to use just "employees" as a criterion in xref:/midpoint/reference/v2/security/authorization/[authorizations] instead of copying the search filter everywhere.
...
Views are defined in xref:/midpoint/reference/v2/admin-gui/admin-gui-config/[admin GUI configuration] data structures:
...
And so on.
Placing definition of view in xref:/midpoint/reference/v2/admin-gui/admin-gui-config/[admin GUI configuration] makes it easy to specify all those details in the appropriate roles.
Therefore, all the roles will have they own customized presentation of the data.


=== Views And Implicit Collections

Some midPoint objects can be considered collections of their own, especially xref:/midpoint/reference/v2/schema/archetypes/[archetypes]. We want to make things simple and elegant whenever possible.
...
* Only partially supported for xref:/midpoint/reference/v2/admin-gui/dashboards/[dashboards] (and even that is experimental).
...
* xref:/midpoint/reference/v2/admin-gui/dashboards/[Customizable Dashboards]