...
| xref:/midpoint/reference/v2/misc/bulk/select/[select]
...
| xref:/midpoint/reference/v2/misc/bulk/filter-content/[filterContent]
...
| xref:/midpoint/reference/v2/misc/bulk/pipeline/[pipeline]
...
| xref:/midpoint/reference/v2/misc/bulk/sequence/[sequence]
...
| xref:/midpoint/reference/v2/misc/bulk/actions/generate-value/[generate-value]
| generateValue
...
| xref:/midpoint/reference/v2/misc/bulk/actions/search/[search]
| search
...
Since 4.8, xref:/midpoint/reference/v2/expressions/expressions/profiles/index.adoc[expression profiles] can be used to fine-tune what actions can be used in a given context.
====
