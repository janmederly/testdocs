...
Lookup table can be bound to any property of any (xref:/midpoint/reference/v2/schema/focus-and-projections/[focal]) object type by using xref:/midpoint/reference/v2/expressions/object-template/[object template]:
