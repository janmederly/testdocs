...
| `report`
| xref:/midpoint/reference/v2/misc/reports/report-functions/[Report Script Library]
provides functions supporting report processing.

| `basic`
| xref:/midpoint/reference/v2/expressions/expressions/script/functions/#basic-library[Basic Library].
Part of standard script evaluator variable set.

| `midpoint`
| xref:/midpoint/reference/v2/expressions/expressions/script/functions/midpoint/[midPoint Script Library].
Part of standard script evaluator variable set.
...
| `log`
| xref:/midpoint/reference/v2/expressions/expressions/script/functions/#midpoint-library[Logging Library].
Part of standard script evaluator variable set.
...
Another example would be xref:/midpoint/reference/v2/misc/reports/examples/reference-search-based-report/[Reference search based report]
...
Documentation for dashboard configuration can be found in xref:/midpoint/reference/v2/admin-gui/dashboards/configuration/[Dashboard configuration].
...
For more information about view configuration please see xref:/midpoint/reference/v2/admin-gui/collections-views/configuration/#views[Views].
...
Some expression security can be achieved by using xref:/midpoint/reference/v2/expressions/expressions/profiles/[expression profiles].
...
* xref:/midpoint/reference/v2/misc/reports/examples/[Report Examples]
