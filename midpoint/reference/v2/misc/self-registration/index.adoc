...
More information about lifecycle configuration, please, see xref:/midpoint/reference/v2/security/authentication/post-authentication-configuration/#configure-lifecycle-activation[Configure lifecycle activation]
