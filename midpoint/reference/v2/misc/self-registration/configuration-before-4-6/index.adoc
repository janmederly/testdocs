...
.Deprecated From MidPoint 4.1 and will be removed in 4.5
====
Configuration attribute '_securityPolicy/authentication/mailAuthentication_' is deprecated. Please use _xref:/midpoint/reference/v2/security/authentication/flexible-authentication/configuration/[Flexible Authentication]_.
====
...
With introducing xref:/midpoint/reference/v2/admin-gui/custom-forms/[custom forms] in midPoint they can be also used with the self-registration.
...
Details for notification configuration are described xref:/midpoint/reference/v2/misc/notifications/configuration/[here].
