...
containers inside xref:/midpoint/reference/v2/concepts/system-configuration-object/[System Configuration Object].
...
Any xref:/midpoint/reference/v2/expressions/expressions/[expressions] supported by midPoint can be used.
...
In the xref:/midpoint/reference/v2/concepts/system-configuration-object/[System Configuration],
