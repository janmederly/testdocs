...
xref:/midpoint/reference/v2/concepts/polystring/[PolyString] is a flexible data structure that has several purposes.
...
Normalizers can be configured in xref:/midpoint/reference/v2/concepts/system-configuration-object/[system configuration object]:
