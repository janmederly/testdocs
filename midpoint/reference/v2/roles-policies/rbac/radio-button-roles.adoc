...
. xref:/midpoint/reference/v2/roles-policies/policy-rules/[Policy Rules] that implement (almost) ordinary xref:/midpoint/reference/v2/roles-policies/segregation-of-duties/[role exclusion].

. The "prune" policy action.

. Clever use of xref:/midpoint/reference/v2/roles-policies/metaroles/gensync/[metarole] to define the radio button class.
