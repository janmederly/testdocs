...
For a more up-to-date samples please visit xref:/midpoint/reference/v2/cases/approval/examples/[this page].
====
...
Expression can be of any supported type, be it xref:/midpoint/reference/v2/expressions/expressions/script/[script expression] or xref:/midpoint/reference/v2/expressions/expressions/[any other expression type].
