...
. Q: Although the structure of certifications is a bit similar to the one of case management (case  work items), in GUI they have a different terminology - see xref:/midpoint/reference/latest/roles-policies/certification/authorization/[Access Certification Security]:
+
