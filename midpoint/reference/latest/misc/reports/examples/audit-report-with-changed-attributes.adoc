...
Please see xref:/midpoint/reference/latest/misc/reports/configuration/#new-report[Report configuration] for basic information about configuration variables.
