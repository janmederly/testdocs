...
| `report`
| xref:/midpoint/reference/latest/misc/reports/report-functions/[Report Script Library]
provides functions supporting report processing.

| `basic`
| xref:/midpoint/reference/latest/expressions/expressions/script/functions/#basic-library[Basic Library].
Part of standard script evaluator variable set.

| `midpoint`
| xref:/midpoint/reference/latest/expressions/expressions/script/functions/midpoint/[midPoint Script Library].
Part of standard script evaluator variable set.
...
| `log`
| xref:/midpoint/reference/latest/expressions/expressions/script/functions/#midpoint-library[Logging Library].
Part of standard script evaluator variable set.
...
Another example would be xref:/midpoint/reference/latest/misc/reports/examples/reference-search-based-report/[Reference search based report]
...
Documentation for dashboard configuration can be found in xref:/midpoint/reference/latest/admin-gui/dashboards/configuration/[Dashboard configuration].
...
For more information about view configuration please see xref:/midpoint/reference/latest/admin-gui/collections-views/configuration/#views[Views].
...
Reports often use xref:/midpoint/reference/latest/expressions/[expressions].
...
The xref:/midpoint/reference/latest/expressions/expressions/script/functions/[expression functions] provided by midPoint usually check for proper authorizations.
...
Some expression security can be achieved by using xref:/midpoint/reference/latest/expressions/expressions/profiles/[expression profiles].
...
xref:/midpoint/reference/latest/security/audit/[Audit records] are *not*  midPoint objects, they are just rows in ordinary relational table.
...
The xref:/midpoint/reference/latest/security/audit/[structure of an audit table is documented] and it can be used for integration with data warehouse and/or SIEM systems.
...
See xref:/midpoint/reference/latest/security/security-guide/[Security Guide] for more detail regarding security-related functionality of midPoint.

== See Also

* xref:/midpoint/reference/latest/misc/reports/examples/[Report Examples]
