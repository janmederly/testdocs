...
In addition to the common xref:/midpoint/reference/latest/expressions/expressions/script/functions/[script expression libraries]
...
* xref:/midpoint/reference/latest/expressions/expressions/script/functions/[Script Expression Functions]
