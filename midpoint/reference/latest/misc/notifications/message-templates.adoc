...
Of course, it is possible to use xref:/midpoint/reference/latest/expressions/expressions/script/[script expression]
with any other supported language (e.g. Groovy), or you can use any other xref:/midpoint/reference/latest/expressions/expressions/[expression evaluator].
