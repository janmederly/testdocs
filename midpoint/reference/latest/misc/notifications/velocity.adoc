...
or xref:/midpoint/reference/latest/misc/notifications/message-templates/[message templates].
...
Note that since midPoint 4.5 you can use xref:/midpoint/reference/latest/misc/notifications/message-templates/[message templates]
