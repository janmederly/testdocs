...
containers inside xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration Object].
...
Any xref:/midpoint/reference/latest/expressions/expressions/[expressions] supported by midPoint can be used.
...
In the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration],
