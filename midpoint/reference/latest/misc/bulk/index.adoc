...
| xref:/midpoint/reference/latest/misc/bulk/search/[search]
...
| xref:/midpoint/reference/latest/misc/bulk/select/[select]
...
| xref:/midpoint/reference/latest/misc/bulk/filter-content/[filterContent]
...
| xref:/midpoint/reference/latest/misc/bulk/pipeline/[pipeline]
...
| xref:/midpoint/reference/latest/misc/bulk/sequence/[sequence]
...
| xref:/midpoint/reference/latest/misc/bulk/actions/generate-value/[generate-value]
