...
Lookup table can be bound to any property of any (xref:/midpoint/reference/latest/schema/focus-and-projections/[focal]) object type by using xref:/midpoint/reference/latest/expressions/object-template/[object template]:
