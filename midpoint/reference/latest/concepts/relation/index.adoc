...
Relation is a mechanism that specifies meaning or purpose of xref:/midpoint/reference/latest/schema/object-references/[object references].
The relation is frequently used to specify the relation of object references of xref:/midpoint/reference/latest/roles-policies/assignment/[assignment/inducement targets] and in the xref:/midpoint/reference/latest/org/organizational-structure/[organizational structure] management.
...
Please see xref:/midpoint/reference/latest/concepts/relation/relation-configuration/[Relation Configuration] page for more details.
