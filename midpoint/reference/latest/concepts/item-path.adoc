...
It is frequently used in xref:/midpoint/reference/latest/expressions/[mappings and expressions], xref:/midpoint/reference/latest/concepts/query/xml-query-language/[search queries], etc.
...
Variable name starts with a dollar sign (`$`). Variables are used in some situations, e.g. in xref:/midpoint/reference/latest/expressions/[mapping expressions], xref:/midpoint/reference/latest/synchronization/correlation-and-confirmation-expressions/[correlation and confirmation expressions], etc.
