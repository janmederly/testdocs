...
Similar to an xref:/midpoint/reference/latest/concepts/iteration/unique-account-username/[unique account username], unique midPoint user names may be configured.
