...
| yes
| Strict xref:/midpoint/reference/latest/concepts/polystring/[PolyString] matching.
Both the original part and the normalized parts are compared.

| `polyStringOrig`
| PolyString
| yes
| Non-strict xref:/midpoint/reference/latest/concepts/polystring/[PolyString] matching.
