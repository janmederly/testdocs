...
E.g. channels can be used to limit execution of certain xref:/midpoint/reference/latest/expressions/mappings/[mappings] to specific situations.
The typical case is to limit application of xref:/midpoint/reference/latest/expressions/mappings/inbound-mapping/[inbound mappings] only to import.
...
See xref:/midpoint/reference/latest/synchronization/flavors/[Synchronization Flavors].
