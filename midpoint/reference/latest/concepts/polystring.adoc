...
See xref:/midpoint/reference/latest/schema/polystring-normalization/[PolyString Normalization Configuration] page for more details.
...
* xref:/midpoint/reference/latest/schema/polystring-normalization/[PolyString Normalization Configuration]
