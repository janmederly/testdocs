...
To better illustrate meaning of various xref:/midpoint/reference/latest/roles-policies/assignment/configuration/#construction-variables[assignment-related variables] let us present an example.
