...
:page-alias: { "parent" : "/midpoint/reference/latest/misc/reports/", "slug" : "certification",  "title" : "Access Certification" }
...
Depending on the xref:/midpoint/reference/latest/roles-policies/certification/determining-case-outcome/[review strategy], some cases might be "stopped": they do not advance to next stage after being e.g. revoked in some (previous) stage.
