...
After xref:/midpoint/reference/latest/cases/escalation/[the escalation feature has been introduced for approvals], it is now available also for certification campaigns.
