...
MidPoint logging configuration is stored in the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration Object]. Therefore this configuration object needs to be modified to set up syslog logging.
...
To do that edit the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration Object] and locate logging configuration in the `logging` element.
...
However, even this xref:/midpoint/reference/latest/diag/initial-logging/[early initialization logging can be reconfigured].
...
* xref:/midpoint/reference/latest/diag/logging/[Logging]

* xref:/midpoint/reference/latest/diag/initial-logging/[Initial Logging Setup HOWTO]

* xref:/midpoint/reference/latest/concepts/system-configuration-object.adoc[System Configuration Object]
