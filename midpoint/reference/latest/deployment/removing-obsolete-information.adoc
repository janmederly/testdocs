...
This is the default configuration from the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration object]:
...
* xref:/midpoint/reference/latest/repository/native-audit/#cleanup-task-vs-partitions[Audit cleanup using task vs partitions]
