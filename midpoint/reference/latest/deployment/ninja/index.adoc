...
Bundled scripts will automatically fill in path to for xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[midPoint home]
...
Check also the xref:/midpoint/reference/latest/repository/native-audit/#audit-migration-from-other-database[migration guide for the Native audit].
...
xref:/midpoint/reference/latest/roles-policies/mining/anonymous-data-export/#anonymous-export-of-role-mining-data[Anonymous Export of Role Mining Data].
