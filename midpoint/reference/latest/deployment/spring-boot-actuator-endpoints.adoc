...
xref:/midpoint/reference/latest/security/authorization/actuators/[Spring Boot Actuator Endpoints Authorizations] page shows authorizations for individual endpoint.
