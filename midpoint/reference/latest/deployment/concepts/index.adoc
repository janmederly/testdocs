...
It is stored in the `config.xml` file in xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[midPoint home directory].
The xref:/midpoint/reference/latest/repository/configuration/[Repository Configuration] page describes the configuration of database access.
...
See xref:/midpoint/reference/latest/upgrade/connectors/[Connector Upgrade] page for more details.
...
See also xref:/midpoint/reference/latest/security/crypto/#keystore[here].
