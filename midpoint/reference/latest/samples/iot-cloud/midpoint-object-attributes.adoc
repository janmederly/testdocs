...
We had to provide a connector implementation for ThingSpeak, described on a xref:/midpoint/reference/latest/samples/iot-cloud/thingspeak-resource/[separate page].
