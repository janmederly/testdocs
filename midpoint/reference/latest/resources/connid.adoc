...
For general advice on using stock connectors in midPoint, please see xref:/midpoint/reference/latest/resources/connector-setup/[].
...
Please see xref:/midpoint/reference/latest/resources/resource-schema/explanation/[Resource and Connector Schema Explanation] for the details.
