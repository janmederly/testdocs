...
And then there is a broad class of xref:/midpoint/reference/latest/resources/manual/[manual resources]. Both cases have one thing in common: resource operations are expensive.
