...
There are resources that natively support `administrativeStatus`xref:/midpoint/reference/latest/concepts/activation/[activation property]. These resources can natively do enable/disable of accounts.
There is nothing to do for these resources except for xref:/midpoint/reference/latest/resources/resource-configuration/schema-handling/activation/[setting up activation mappings].
...
This is called _configured_ capability and it is set up in xref:/midpoint/reference/latest/resources/resource-configuration/capabilities/[Resource Capabilities] section.
...
Just add this section to xref:/midpoint/reference/latest/resources/resource-configuration/capabilities/[Resource Capabilities] section:
...
Therefore all that needs to be done is xref:/midpoint/reference/latest/resources/resource-configuration/schema-handling/activation/[setting up activation mappings] for `administrativeStatus` property - exactly the same way as if the resource supported the capability in a native way.
...
* xref:/midpoint/reference/latest/resources/resource-configuration/capabilities/[Resource Capabilities]
