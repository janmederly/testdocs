...
The `consistency` section of xref:/midpoint/reference/latest/resources/resource-configuration/[Resource Configuration] contains configuration of various data consistency mechanisms and features.
