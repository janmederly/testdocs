...
Activation part of resource object type definition is located in xref:/midpoint/reference/latest/resources/resource-configuration/schema-handling/[Resource Schema Handling] part of resource definition.
...
The legality is determined by evaluating xref:/midpoint/reference/latest/roles-policies/assignment/[assignments] and the assignment enforcement mode.
...
See xref:/midpoint/reference/latest/roles-policies/assignment/[Assignment]
...
Administrative status mapping maps xref:/midpoint/reference/latest/concepts/activation/[activation administrative status] from the focal object (user) to the administrative status of resource object.
...
The xref:/midpoint/reference/latest/expressions/mappings/[Mapping] can optionally have a time constraints.
