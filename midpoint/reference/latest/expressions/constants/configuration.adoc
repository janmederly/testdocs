...
See xref:/midpoint/reference/latest/expressions/constants/[Constants] page for motivation and general introduction to the concept of constants.


== Configuration

The constants are defined in the midPoint configuration file (config.xml) in xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[midPoint home directory]:
...
Constants are usually used in xref:/midpoint/reference/latest/expressions/expressions/[expressions]. There is a special `const` expression evaluator for easy use of the constants.
