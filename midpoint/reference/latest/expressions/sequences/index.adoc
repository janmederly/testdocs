...
This may seem simple, but the real power in using sequences are in combination with xref:/midpoint/reference/latest/expressions/[Mappings and Expressions]. The sequence can easily be used in a mapping:
...
See xref:/midpoint/reference/latest/expressions/sequences/configuration/[Using Sequences] page for more details.
