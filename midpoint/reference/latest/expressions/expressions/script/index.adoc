...
* xref:/midpoint/reference/latest/misc/notifications/velocity/[Velocity] (since 3.4.1) for expressions returning strings/texts
...
See xref:/midpoint/reference/latest/expressions/expressions/[Expression] page for more generic information about the use of variables in expressions.

== Functions

See xref:/midpoint/reference/latest/expressions/expressions/script/functions/midpoint/[MidPoint Script Library] for more details.

== Absolute and Relative Script Expressions

MidPoint always works with xref:/midpoint/reference/latest/concepts/relativity/[relative changes].
...
MidPoint always operates in xref:/midpoint/reference/latest/concepts/relativity/[relative mode], therefore at the end of the evaluation midPoint will diff the value to create a xref:/midpoint/devel/prism/concepts/deltas/[delta].
