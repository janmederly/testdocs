...
the differences are mentioned in the xref:/midpoint/reference/latest/concepts/query/[midPoint Query] document;
...
* supports xref:/midpoint/reference/latest/repository/native-audit/#partitioning[audit table partitioning];
