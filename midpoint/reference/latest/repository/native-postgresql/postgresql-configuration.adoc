...
also for xref:/midpoint/reference/latest/repository/native-audit/[SQL Audit] and
xref:/midpoint/reference/latest/tasks/task-manager/configuration/[Task Manager] duties.
...
configure xref:/midpoint/reference/latest/security/audit/#separate-repository-configuration-for-audit[separate audit repository].
