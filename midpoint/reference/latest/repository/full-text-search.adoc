...
* xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL repository]

* xref:/midpoint/reference/latest/repository/generic/[Generic repository implementation] - not recommended from 4.4 on
