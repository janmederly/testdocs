...
* Check the xref:/midpoint/reference/latest/deployment/clustering-ha/[Clustering / high availability setup]
...
See xref:/midpoint/reference/latest/repository/native-postgresql/postgresql-configuration/#connections[PostgreSQL Configuration] for more tips.
...
xref:/midpoint/reference/latest/tasks/task-manager/configuration/[Task Manager] and
xref:/midpoint/reference/latest/repository/native-audit/#sql-audit-using-its-own-database[dedicated SQL Audit DB].
