...
[NOTE]
This page discusses deprecated repository implementation that was replaced with xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL reposit].
...
For more complex configurations using different DB vendors see xref:/midpoint/reference/latest/repository/generic/configuration/[Repository Configuration].
...
See the relevant section in xref:/midpoint/reference/latest/concepts/query/#differences-in-filter-interpretation[Query API]
