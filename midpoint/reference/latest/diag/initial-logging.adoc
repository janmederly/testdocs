...
* Adding `logback.xml` file in xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[MidPoint Home Directory].
...
This logging is configured in the xref:/midpoint/reference/latest/concepts/system-configuration-object/[system
