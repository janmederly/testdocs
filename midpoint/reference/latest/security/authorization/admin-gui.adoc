...
| Showing menu items for xref:/midpoint/reference/latest/admin-gui/collections-views/[views] that are configured for users.
|
...
| Showing menu items for xref:/midpoint/reference/latest/admin-gui/collections-views/[views] that are configured for roles.
| Since 4.0.1
...
| Showing menu items for xref:/midpoint/reference/latest/admin-gui/collections-views/[views] that are configured for cases.
|
...
Please see xref:/midpoint/reference/latest/roles-policies/certification/authorization/[Access Certification Security] for detailed list.

== Focal object tabs authorizations

Display of object detail tabs is *not* controlled by authorizations.
xref:/midpoint/reference/latest/admin-gui/admin-gui-config/[Admin GUI Configuration] is used to control this behavior.

== See also:

* xref:/midpoint/reference/latest/admin-gui/admin-gui-config/[Admin GUI Configuration]
