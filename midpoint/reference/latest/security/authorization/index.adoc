...
The xref:/midpoint/reference/latest/security/authorization/configuration/[Authorization Configuration] pages provides a detailed description of the configuration of midPoint authorization statements.


== See Also

* xref:/midpoint/reference/latest/security/authorization/configuration/[Authorization Configuration]

* xref:/midpoint/reference/latest/roles-policies/rbac/[]
