...
** See updated xref:/midpoint/reference/latest/misc/self-registration[Self Registration documentation] for midPoint 4.6.1 and 4.7.1.
** See xref:/midpoint/reference/latest/misc/self-registration/configuration-before-4-6/[Self Registration configuration before 4.6] for midPoint 4.4.5.
