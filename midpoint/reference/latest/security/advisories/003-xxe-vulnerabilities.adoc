...
E.g. system administrators can use xref:/midpoint/reference/latest/expressions/expressions/script/[script expression] to get the same information as is exposed by the XXE vulnerabilities.
