...
See xref:/midpoint/reference/latest/security/advisories/[Security Advisories] page for details.
...
Please see xref:/midpoint/reference/latest/security/credentials/password-storage-configuration/[Password Storage Configuration] page for the details.
...
One of the most powerful parts of midPoint are xref:/midpoint/reference/latest/expressions/[mappings and expressions]. Expressions allow to customize midPoint behavior and they are essential for the success of midPoint deployments.
...
Some expression security can be achieved by using xref:/midpoint/reference/latest/expressions/expressions/profiles/[expression profiles]. However, the usefulness of this feature is currently limited.
See xref:/midpoint/reference/latest/expressions/expressions/profiles/configuration/[Expression Profile Configuration] page for details.
...
xref:/midpoint/reference/latest/deployment/stand-alone-deployment/[Stand-alone deployment] of midPoint is supposed to expose only HTTP port 8080 by default.
...
See also xref:/midpoint/reference/latest/deployment/ports-80-and-443/[Ports 80 and 443].
...
MidPoint is exposing remote services, such as xref:/midpoint/reference/latest/interfaces/rest/[RESTful API]. Those services provide access to a significant part of midPoint functionality.
...
However, special xref:/midpoint/reference/latest/security/authorization/[authorization] is required to access those services.
...
* xref:/midpoint/reference/latest/security/advisories/[Security Advisories]

* xref:/midpoint/reference/latest/deployment/ports-80-and-443/[Ports 80 and 443]