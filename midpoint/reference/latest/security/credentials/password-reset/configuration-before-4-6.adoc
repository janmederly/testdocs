...
[NOTE]
====
This mechanisms is soon to be replaced by a xref:/midpoint/reference/latest/security/credentials/password-reset/new-configuration/[New Password Reset Configuration].
====
...
With introducing xref:/midpoint/reference/latest/admin-gui/custom-forms/[custom forms] they can be used to specify custom form for user identification.
