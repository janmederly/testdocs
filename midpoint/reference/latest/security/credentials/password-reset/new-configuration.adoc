...
The old xref:/midpoint/reference/latest/security/credentials/password-reset/[Reset Password Configuration] is a very limited and somehow non-systemic feature.
...
This change need to be reflected to the interfaces as well (xref:/midpoint/reference/latest/interfaces/model-java/[IDM Model Interface], xref:/midpoint/reference/latest/interfaces/rest/[REST API]). There needs to be several new methods:
...
* xref:/midpoint/reference/latest/security/credentials/password-reset/[Reset Password Configuration] (old configuration, soon to be deprecated)