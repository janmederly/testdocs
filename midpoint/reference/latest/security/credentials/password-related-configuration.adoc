...
* xref:/midpoint/reference/latest/security/credentials/password-policy/[Password Policy] is used to enforce password strength (complexity).
...
* Password xref:/midpoint/reference/latest/security/credentials/password-storage-configuration/[storage scheme] is configured in Security Policy object.

Most of the password-related settings are located in the xref:/midpoint/reference/latest/security/security-policy/[Security Policy object] where also policies for other credential types are located.


== Password Policy

See xref:/midpoint/reference/latest/security/credentials/password-policy/[Password Policy] page.

Use xref:/midpoint/reference/latest/security/security-policy/[Security Policy object] to reference password policy:
...
See xref:/midpoint/reference/latest/security/credentials/password-storage-configuration/[Password Storage Configuration] page.


== Deprecated Configuration

Starting with midPoint 3.6 all password-related configuration should be done by using the xref:/midpoint/reference/latest/security/security-policy/[Security Policy object]. The direct password policy references in system configuration or organizations are now deprecated.
...
* xref:/midpoint/reference/latest/security/security-policy/[Security Policy Configuration]

* xref:/midpoint/reference/latest/security/credentials/password-policy/[Password Policy]

* xref:/midpoint/reference/latest/security/credentials/password-storage-configuration/[Password Storage Configuration]