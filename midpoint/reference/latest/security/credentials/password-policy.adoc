...
Global password policy is specified in the  xref:/midpoint/reference/latest/security/security-policy/[global security policy].
...
** *persona*: any xref:/midpoint/reference/latest/misc/persona/[persona] of the object.
...
The example above is a password policy that prohibits linked xref:/midpoint/reference/latest/misc/persona/[personas] to have the same password.
