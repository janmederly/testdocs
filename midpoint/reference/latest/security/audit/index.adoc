...
| Channel
| `ch`
| The xref:/midpoint/reference/latest/concepts/channel/[channel] that was the source of the operation that this record describes
...
[NOTE]
Column *Event DB ID* is relevant only for the older xref:/midpoint/reference/latest/repository/generic/generic-audit/[Generic Repository].
The new xref:/midpoint/reference/latest/repository/native-audit/[Native PostgreSQL Repository] uses custom types displaying the name in the first column.
...
This may include processing xref:/midpoint/reference/latest/roles-policies/rbac/[RBAC], expressions, workflows or other "plugin" hooks.
...
To enable the audit implementation, `auditService` section must be added to the `audit` element of the xref:/midpoint/reference/latest/deployment/midpoint-home-directory/#configuration-file[config.xml].
...
. Enable it in the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration]
...
Audit service writing to database tables is closely related to the xref:/midpoint/reference/latest/repository/[repository] implementation:

* If the xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL Repository] is used,
see xref:/midpoint/reference/latest/repository/native-audit/[Native PostgreSQL Audit Trail]
for more details, including how to configure it.

* If the deprcated xref:/midpoint/reference/latest/repository/generic/[Generic SQL Repository] is used,
see xref:/midpoint/reference/latest/repository/generic/generic-audit/[Generic SQL Audit Trail].
...
For that we need to add the next snippet of code to the xref:/midpoint/reference/latest/concepts/system-configuration-object/[System Configuration object].
...
see xref:/midpoint/reference/latest/repository/native-audit/#audit-tables[audit tables] for more details.
Generic repository uses `m_audit_resource` to store the information, see
xref:/midpoint/reference/latest/repository/generic/generic-audit/#audit-tables[audit tables] for more details.
...
* If the xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL Repository] is used,
see xref:/midpoint/reference/latest/repository/native-audit/#custom-column[Custom Column] in Native SQL Audit Trail.

* If the deprcated xref:/midpoint/reference/latest/repository/generic/[Generic SQL Repository] is used,
see xref:/midpoint/reference/latest/repository/generic/generic-audit/#custom-column[Custom Column] in Generic SQL Audit Trail.
...
* If the xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL Repository] is used,
see xref:/midpoint/reference/latest/repository/native-audit/#sql-audit-using-its-own-database[Audit to separate database] in the Native SQL Audit Trail.

* If the deprcated xref:/midpoint/reference/latest/repository/generic/[Generic SQL Repository] is used,
see xref:/midpoint/reference/latest/repository/generic/generic-audit/#audit-to-separate-database[Audit to separate database] in the Generic SQL Audit Trail.
...
* If the xref:/midpoint/reference/latest/repository/native-postgresql/[Native PostgreSQL Repository] is used,
see the xref:/midpoint/reference/latest/repository/native-audit/#configuration-examples[examples for the Native SQL Audit Trail].

* If the deprcated xref:/midpoint/reference/latest/repository/generic/[Generic SQL Repository] is used,
see the xref:/midpoint/reference/latest/repository/generic/generic-audit/#configuration-examples[examples for the Generic SQL Audit Trail].

== See Also

* xref:/midpoint/reference/latest/repository/native-audit/[Native PostgreSQL Audit Trail]

* xref:/midpoint/reference/latest/repository/generic/generic-audit/[Generic SQL Audit Trail]
