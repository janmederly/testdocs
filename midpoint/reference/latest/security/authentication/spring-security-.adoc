...
This configuration is unsupported from version 4.1. For the solution to this problem see xref:/midpoint/reference/latest/security/authentication/flexible-authentication/[Flexible Authentication] and xref:/midpoint/reference/latest/security/authentication/flexible-authentication/configuration/[Flexible Authentication Configuration].
====
...
It can be also configured as a part of your xref:/midpoint/reference/latest/legacy/sso/[SSO] solution.
...
Unless midPoint is a part of a xref:/midpoint/reference/latest/legacy/sso/midpoint-as-cas-client-java-jasig-cas-client-libraries-/[CAS SSO solution], no modifications are needed to this file.
...
* xref:/midpoint/reference/latest/legacy/sso/midpoint-as-cas-client-apache-cas-agent-method-/[MidPoint as CAS Client (Apache CAS Agent Method)]

* xref:/midpoint/reference/latest/legacy/sso/midpoint-as-cas-client-java-jasig-cas-client-libraries-/[MidPoint as CAS Client (Java Jasig CAS Client libraries)]