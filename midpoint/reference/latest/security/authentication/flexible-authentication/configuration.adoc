...
Flexible authentication is configured in xref:/midpoint/reference/latest/security/security-policy[Security Policy]. Security policy can be defined on different levels.
