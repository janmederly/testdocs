...
Flexible authentication is configured in xref:/midpoint/reference/latest/security/security-policy[Security Policy], which is used as global security policy in System Configuration.
