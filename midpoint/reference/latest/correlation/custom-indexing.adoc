...
. data in xref:/midpoint/reference/latest/correlation/multiple-identity-data-sources/["multi-source" items].
...
| `configuration`
| `polyString`
| Configuration of xref:/midpoint/reference/latest/schema/polystring-normalization/[`PolyString` normalizer].
...
. This feature is available on the xref:/midpoint/reference/latest/repository/native-postgresql/[native repository] only.
...
- xref:/midpoint/reference/latest/correlation/items-correlator/[Item-based correlator]
