...
and xref:/midpoint/reference/latest/synchronization/consistency/theory/[Consistency Theory] for
...
xref:/midpoint/reference/latest/resources/shadow/[shadow objects] in a form of _pending operations_.
...
xref:/midpoint/reference/latest/resources/provisioning-dependencies/[provisioning dependencies] prohibiting that.
...
xref:/midpoint/reference/latest/resources/manual/[manual resources].
This is an example of xref:/midpoint/features/synergy/[synergy] of several midPoint features.
====

=== Configuration

Operation retries can be configured in xref:/midpoint/reference/latest/resources/resource-configuration/[resource definition]
...
Main page: xref:/midpoint/reference/latest/tasks/shadow-refresh-task/[Shadow Refresh Task]
...
This is often achieved by the means of a xref:/midpoint/reference/latest/synchronization/introduction/[reconciliation process].
...
[TIP]
====
This is the same refresh task that is used for xref:/midpoint/reference/latest/resources/manual/configuration/[manual resources].
...
See xref:/midpoint/reference/latest/tasks/shadow-refresh-task/[Shadow Refresh Task] page for more details.
...
As discovery is yet another way how midPoint detects changes, all what you need is to have configured xref:/midpoint/reference/latest/synchronization/introduction/[synchronization] part in the resource description.

== Reconciliation

xref:/midpoint/reference/latest/synchronization/introduction/[Reconciliation process] (also called synchronization)
...
For information about the earlier versions please see xref:/midpoint/reference/latest/synchronization/consistency/leagacy/[Consistency mechanism (3.8 and earlier)] page.

== See Also

* xref:/iam/idm-consistency/[IDM Consistency]

* xref:/midpoint/reference/latest/synchronization/consistency/theory/[Consistency Theory]

* xref:/midpoint/reference/latest/concepts/relativity/[Relativity]

* xref:/midpoint/reference/latest/synchronization/introduction/[Reconciliation process]

* xref:/midpoint/reference/latest/tasks/shadow-refresh-task/[Shadow Refresh Task]
