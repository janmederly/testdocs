...
* xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-1-hardware-tokens/[Linked objects scenario 1: Hardware tokens]

* xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-2-devices-owned-by-users/[Linked objects scenario 2: Devices owned by users]

* xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-3-projects/[Linked objects scenario 3: Projects]

* xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-4-clubs/[Linked objects scenario 4: Clubs]

* xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-5-deletion-safe-organizations/[Linked objects scenario 5: Deletion-safe organizations]
...
(More information on this topic can be found e.g. on xref:/midpoint/reference/latest/concepts/relation/[Relation] and xref:/midpoint/reference/latest/concepts/relation/relation-configuration/[Relation Configuration] pages.)
...
See also xref:/midpoint/reference/latest/misc/bulk/actions/recompute/[recompute] for more information on object recomputation.
...
See xref:/midpoint/reference/latest/misc/bulk/actions/recompute/[recompute] for more details.
...
. Where to attach change propagation policy rules? For example, in user  device scenario (xref:/midpoint/reference/latest/synchronization/linked-objects/scenario-2-devices-owned-by-users/[Linked objects scenario 2: Devices owned by users]) policy rule that causes recomputation of linked devices can be put either into user archetype (with order 1 inducement) or device archetype (with order 2 inducement).
