...
[WARNING]
====
This scenario uses unfinished/experimental xref:/midpoint/reference/latest/synchronization/linked-objects/named-object-links/[named object links] feature.
