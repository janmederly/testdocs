...
To prevent this, we include `matchesRuleAssignment` = `true` clause, described on xref:/midpoint/reference/latest/synchronization/linked-objects/[Linked objects] page.
