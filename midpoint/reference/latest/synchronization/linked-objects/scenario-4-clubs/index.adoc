...
(The code could be made a bit more concise if xref:/midpoint/reference/latest/synchronization/linked-objects/named-object-links/[named object links] are used.)
