...
The most significant part of each phase is application of xref:/midpoint/reference/latest/expressions/mappings/[mappings]. The input and output of applied mappings is different for each phase.
