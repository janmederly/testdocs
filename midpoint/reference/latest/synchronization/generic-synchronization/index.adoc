...
The same principle can also be used for other object types such as xref:/midpoint/reference/latest/org/organizational-structure/[Orgs] (midPoint organizational units) and groups.
...
And actually the extremely poweful xref:/midpoint/reference/latest/roles-policies/rbac/[RBAC] mechanism can also be reused for these unusual links creating a kind of meta-roles.
