...
Simple widgets can present data from xref:/midpoint/reference/latest/admin-gui/collections-views/[object collections], such as number of active employees, number of failed resources, suspended tasks and so.
...
But their integration with xref:/midpoint/reference/latest/admin-gui/collections-views/[object collections] brings interesting possibilities.
...
Please see xref:/midpoint/reference/latest/roles-policies/policy-rules/[Policy Rules] for more details.
