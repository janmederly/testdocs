...
- xref:/midpoint/reference/latest/admin-gui/dashboards/[Customizable Dashboards] page provides basic information about this feature.
...
You can see basic configuration for objectCollection on xref:/midpoint/reference/latest/admin-gui/collections-views/configuration/#object-collection[Object Collection].
