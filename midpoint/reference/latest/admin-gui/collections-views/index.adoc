...
E.g. views can adjusted and overridden in xref:/midpoint/reference/latest/admin-gui/admin-gui-config/[admin GUI configuration].
...
* xref:/midpoint/reference/latest/admin-gui/collections-views/configuration/[Object Collections and Views Configuration]
