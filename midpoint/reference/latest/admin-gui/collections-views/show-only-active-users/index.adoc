...
This would normally be done by using xref:/midpoint/reference/latest/security/authorization/[authorizations]. But authorizations have their limits.
...
But there is an elegant way how to limit listing of objects in midPoint user interface: xref:/midpoint/reference/latest/admin-gui/collections-views/[Object Collections and Views]. This feature was partially implemented in midPoint 3.9 specifically for the purpose of satisfying this use case.
