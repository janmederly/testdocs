...
For an introduction to the role catalog concept please see xref:/midpoint/reference/latest/admin-gui/role-catalog/[Role Catalog] page.


== Role Catalog Implementation

Simply speaking, role catalog is just an xref:/midpoint/reference/latest/org/organizational-structure/[organizational structure] structure.
...
The root of this role catalog needs to be configured in the xref:/midpoint/reference/latest/concepts/system-configuration-object/[system configuration object] like this:
