...
* xref:/midpoint/reference/latest/misc/self-registration/[Configuring self-registraion]

* xref:/midpoint/reference/latest/security/credentials/password-reset/[Configuring reset password]
