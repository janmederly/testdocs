...
:page-replaced-by: /midpoint/reference/latest/schema/archetypes/
...
Roles, orgs, and services can act as a smart replacement for xref:/midpoint/reference/latest/schema/generic-objects/[generic objects].
...
E.g. xref:/midpoint/reference/latest/expressions/object-template/[object template] can be applied on per-subtype-basis.
...
In MidPoint 4.0, xref:/midpoint/reference/latest/schema/archetypes/[Archetypes] should provide complete replacement for subtype functionality.
...
Therefore subtype is often combined with xref:/midpoint/reference/latest/roles-policies/metaroles/policy/[metaroles]. Metaroles are a very efficient mechanism to specify common behavior and policies for groups of objects.

== See Also

* xref:/midpoint/reference/latest/schema/generic-objects/[Generic Objects]
