...
xref:/midpoint/reference/latest/concepts/polystring/[PolyString] is a flexible data structure that has several purposes.
...
Normalizers can be configured in xref:/midpoint/reference/latest/concepts/system-configuration-object/[system configuration object]:
...
* xref:/midpoint/reference/latest/concepts/polystring/[PolyString]
