...
The User object is one of the objects of midPoint xref:/midpoint/reference/latest/schema/[Data Model] that is built on top of xref:/midpoint/devel/prism/[Prism Objects]. MidPoint data model is a kind of _common denominator_ model.
...
See xref:/midpoint/reference/latest/resources/shadow/[Shadow Objects] for more information.
