...
:page-moved-from: /midpoint/reference/latest/synchronization/live-sync-error-handling-strategy/
...
xref:/midpoint/reference/latest/tasks/activities/object-set-specification/#_failed_objects_selector[failed objects selector]
