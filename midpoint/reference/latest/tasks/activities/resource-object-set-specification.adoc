...
This configuration is used mainly for xref:/midpoint/reference/latest/tasks/synchronization-tasks/[synchronization activities].
...
For 4.6 and above, please see xref:/midpoint/reference/latest/resources/resource-configuration/schema-handling/changes-in-4.6.adoc#_defaults_for_kind_and_intent[how the defaults are handled].
