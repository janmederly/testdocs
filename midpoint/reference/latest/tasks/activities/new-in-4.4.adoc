...
xref:/midpoint/reference/latest/tasks/activities/[here] for in-depth description.
...
1. New xref:/midpoint/reference/latest/tasks/auto-scaling/[auto-scaling activity] was created.
...
The xref:/midpoint/reference/latest/tasks/thresholds/[threshold mechanism] before 4.4 was limited to a single node.
