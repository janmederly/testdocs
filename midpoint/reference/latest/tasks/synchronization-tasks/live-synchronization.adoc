...
The heart of the configuration is the specification of what xref:/midpoint/reference/latest/tasks/activities/resource-object-set-specification/[resource objects]
...
(See xref:/midpoint/reference/latest/resources/resource-configuration/capabilities/[]).
...
custom xref:/midpoint/reference/latest/tasks/task-error-handling/[error handling specification].
