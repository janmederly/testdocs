...
xref:/midpoint/reference/latest/synchronization/introduction/[synchronization] of midPoint objects.
...
[TIP]
====
All the synchronization tasks are using the same xref:/midpoint/reference/latest/synchronization/introduction/[synchronization mechanism].
See the xref:/midpoint/reference/latest/synchronization/introduction/[Synchronization] page for an introduction.

For all the synchronization tasks to work correctly the xref:/midpoint/reference/latest/resources/resource-configuration/synchronization/[synchronization section]
of xref:/midpoint/reference/latest/resources/resource-configuration/[resource configuration] must be set up properly.
See xref:/midpoint/reference/latest/resources/resource-configuration/synchronization/[Synchronization Configuration] page for more details.
====
...
xref:/midpoint/reference/latest/resources/shadow/kind-intent-objectclass/['object class, kind, and intent']
using xref:/midpoint/reference/latest/tasks/activities/resource-object-set-specification/[these settings].

=== MidPoint 4.4 and After

The resource objects are specified using xref:/midpoint/reference/latest/tasks/activities/resource-object-set-specification/[`resourceObjects`]
...
* xref:/midpoint/reference/latest/tasks/activities/[Activities]

* xref:/midpoint/reference/latest/tasks/recompute-task/[Recompute Task]
