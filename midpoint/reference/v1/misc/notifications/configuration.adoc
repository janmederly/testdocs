...
containers inside xref:/midpoint/reference/v1/concepts/system-configuration-object/[System Configuration Object].
...
In the xref:/midpoint/reference/v1/concepts/system-configuration-object/[System Configuration],
