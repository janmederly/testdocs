...
E.g. channels can be used to limit execution of certain xref:/midpoint/reference/v1/expressions/mappings/[mappings] to specific situations.
The typical case is to limit application of xref:/midpoint/reference/v1/expressions/mappings/inbound-mapping/[inbound mappings] only to import.
...
See xref:/midpoint/reference/v1/synchronization/flavors/[Synchronization Flavors].
