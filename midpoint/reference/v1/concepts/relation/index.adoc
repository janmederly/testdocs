...
Relation is a mechanism that specifies meaning or purpose of xref:/midpoint/reference/v1/schema/object-references/[object references].
The relation is frequently used to specify the relation of object references of xref:/midpoint/reference/v1/roles-policies/assignment/[assignment/inducement targets] and in the xref:/midpoint/reference/v1/org/organizational-structure/[organizational structure] management.
...
Please see xref:/midpoint/reference/v1/concepts/relation/relation-configuration/[Relation Configuration] page for more details.
...
* xref:/midpoint/reference/v1/concepts/relation/relation-configuration/[Relation Configuration]