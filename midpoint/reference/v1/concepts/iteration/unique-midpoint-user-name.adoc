...
Similar to an xref:/midpoint/reference/v1/concepts/iteration/unique-account-username/[unique account username], unique midPoint user names may be configured.
