...
It is stored in the `config.xml` file in xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[midPoint home directory].
The xref:/midpoint/reference/v1/repository/configuration/[Repository Configuration] page describes the configuration of database access.
...
See xref:/midpoint/reference/v1/upgrade/connectors/[Connector Upgrade] page for more details.
...
See also xref:/midpoint/reference/v1/security/crypto/#keystore[here].
