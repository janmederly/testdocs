...
MidPoint supports _partial multi-tenancy_. In fact, midPoint multi-tenancy is mostly just an extension of xref:/midpoint/reference/v1/org/organizational-structure/[organizational structure] features.
...
See xref:/midpoint/reference/v1/security/authorization/configuration/[Authorization Configuration] page for more details.
...
This is partially related to planned xref:/midpoint/reference/v1/schema/archetypes/[Archetypes] feature.
