...
This is the default configuration from the xref:/midpoint/reference/v1/concepts/system-configuration-object/[System Configuration object]:
...
* xref:/midpoint/reference/v1/repository/native-audit/#cleanup-task-vs-partitions[Audit cleanup using task vs partitions]
