...
MidPoint is often deployed as a xref:/midpoint/reference/v1/deployment/stand-alone-deployment/[stand-alone server] with an embedded Apache Tomcat container.
