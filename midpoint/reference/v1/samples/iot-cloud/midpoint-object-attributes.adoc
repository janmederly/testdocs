...
We had to provide a connector implementation for ThingSpeak, described on a xref:/midpoint/reference/v1/samples/iot-cloud/thingspeak-resource/[separate page].
