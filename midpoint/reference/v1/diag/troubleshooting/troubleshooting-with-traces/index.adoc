...
More information about the Trace view is on xref:/midpoint/reference/v1/diag/troubleshooting/troubleshooting-with-traces/trace-visualization/[Trace visualization] page.
