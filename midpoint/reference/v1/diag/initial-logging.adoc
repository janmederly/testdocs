...
* Adding `logback.xml` file in xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[MidPoint Home Directory].
...
This logging is configured in the xref:/midpoint/reference/v1/concepts/system-configuration-object/[system
...
* xref:/midpoint/reference/v1/deployment/syslog-logging/[Syslog Logging]
