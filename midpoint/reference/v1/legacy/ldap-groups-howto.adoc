...
Version 3.0 will introduced the mechanism of xref:/midpoint/reference/v1/resources/entitlements/[Entitlements] which makes handling of groups much easier.
====
