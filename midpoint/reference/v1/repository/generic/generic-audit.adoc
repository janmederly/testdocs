...
For the new Native PostgreSQL audit trail see xref:/midpoint/reference/v1/repository/native-audit/[this page].
...
Configuration element *auditService* for *SqlAuditServiceFactory* can contain any element from *repository* configuration - see xref:/midpoint/reference/v1/repository/generic/configuration/[Repository Configuration] for more.
...
For PostgreSQL example, see xref:/midpoint/reference/v1/repository/generic/postgresql/[PostgreSQL] page, section *Separate audit database*.
