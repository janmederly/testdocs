...
NOTE: See xref:/midpoint/reference/v1/deployment/ninja[Ninja] for more export configuration options and their meaning.
...
See xref:/midpoint/reference/v1/repository/native-postgresql/usage[Using Native PostgreSQL Repository]
...
This would create the xref:/midpoint/reference/v1/deployment/initial-objects/[initial objects] and irrelevant audit records
...
Also, be sure you initialized xref:/midpoint/reference/v1/repository/native-audit/#partitioning[audit table partitions] if you want to use them.
====
...
NOTE: See xref:/midpoint/reference/v1/deployment/ninja[Ninja] for more import configuration options and their meaning
...
Check xref:/midpoint/reference/v1/repository/native-audit/#audit-migration-from-other-database[Audit migration from other databases] section from xref:/midpoint/reference/v1/repository/native-audit/[Native PostgreSQL Audit Trail] document for more details.
