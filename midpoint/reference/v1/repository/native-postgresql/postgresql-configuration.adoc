...
also for xref:/midpoint/reference/v1/repository/native-audit/[SQL Audit] and
xref:/midpoint/reference/v1/tasks/task-manager/configuration/[Task Manager] duties.
...
configure xref:/midpoint/reference/v1/security/audit/#separate-repository-configuration-for-audit[separate audit repository].
