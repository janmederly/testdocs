...
xref:/midpoint/reference/v1/schema/custom-schema-extension/[schema extensions].
...
In theory, xref:/midpoint/reference/v1/concepts/relativity/[relativity of midPoint] means that modifications
