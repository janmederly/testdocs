...
the differences are mentioned in the xref:/midpoint/reference/v1/concepts/query/[midPoint Query] document;
...
* supports xref:/midpoint/reference/v1/repository/native-audit/#partitioning[audit table partitioning];
