...
. data in xref:/midpoint/reference/v1/correlation/multiple-identity-data-sources/["multi-source" items].
...
| `configuration`
| `polyString`
| Configuration of xref:/midpoint/reference/v1/schema/polystring-normalization/[`PolyString` normalizer].
...
. This feature is available on the xref:/midpoint/reference/v1/repository/native-postgresql/[native repository] only.
...
- xref:/midpoint/reference/v1/correlation/items-correlator/[Item-based correlator]
