...
* xref:/midpoint/reference/v1/misc/self-registration/[Configuring self-registraion]

* xref:/midpoint/reference/v1/security/credentials/password-reset/[Configuring reset password]
