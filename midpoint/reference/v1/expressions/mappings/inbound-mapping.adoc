...
Inbound mapping is a xref:/midpoint/reference/v1/expressions/mappings/[mapping] that transforms data from a xref:/midpoint/reference/v1/schema/focus-and-projections/[projection] (e.g. an account) on the resource side to a xref:/midpoint/reference/v1/schema/focus-and-projections/[focal object] (e.g. a user) on the midPoint side.
...
Please see the xref:/midpoint/reference/v1/synchronization/introduction/[Synchronization] page for a generic description of the synchronization process and the specific place where inbound mappings are used.
...
See xref:/midpoint/reference/v1/expressions/mappings/[] page for the details.
...
See xref:/midpoint/reference/v1/expressions/mappings/[] page for a detailed discussion of mapping ranges.
...
They are not completely xref:/midpoint/reference/v1/concepts/relativity/[relativistic].
