...
To prevent this, we include `matchesRuleAssignment` = `true` clause, described on xref:/midpoint/reference/v1/synchronization/linked-objects/[Linked objects] page.
