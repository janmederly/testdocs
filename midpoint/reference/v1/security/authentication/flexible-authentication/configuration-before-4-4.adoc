...
Flexible authentication is configured in xref:/midpoint/reference/v1/security/security-policy[Security Policy], which is used as global security policy in System Configuration.
