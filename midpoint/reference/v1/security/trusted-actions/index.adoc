...
=== Problem
The xref:/midpoint/reference/v1/admin-gui/admin-gui-config/#custom-actions-for-object-lists[custom GUI actions for object lists] are currently implemented using task templates.
...
* xref:/midpoint/reference/v1/expressions/expressions/profiles/configuration/[Expression Profile Configuration]
