...
The xref:/midpoint/reference/v1/security/authorization/configuration/[Authorization Configuration] pages provides a detailed description of the configuration of midPoint authorization statements.


== See Also

* xref:/midpoint/reference/v1/security/authorization/configuration/[Authorization Configuration]

* xref:/midpoint/reference/v1/roles-policies/rbac/[]
