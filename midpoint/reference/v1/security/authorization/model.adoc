...
| xref:/midpoint/reference/v1/schema/focus-and-projections/[Focal object] that receives the assignment (e.g. a user)
...
| xref:/midpoint/reference/v1/schema/focus-and-projections/[Focal object] from which the assignment is removed (e.g. a user)
| Object which is the target of assignment (e.g. Role or Org)
...
| N/A
| N/A
| Allows to execute xref:/midpoint/reference/v1/misc/bulk/[midPoint scripts a.k.a. bulk actions]
