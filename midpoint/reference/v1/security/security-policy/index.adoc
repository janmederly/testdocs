...
The security policy object is usually referenced from xref:/midpoint/reference/v1/concepts/system-configuration-object/[System Configuration Object]:
...
Since midPoint 3.6 the security policy may also be specified for each xref:/midpoint/reference/v1/org/organizational-structure/[organizational unit].
