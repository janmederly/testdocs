...
Global password policy is specified in the  xref:/midpoint/reference/v1/security/security-policy/[global security policy].
...
** *persona*: any xref:/midpoint/reference/v1/misc/persona/[persona] of the object.
...
The example above is a password policy that prohibits linked xref:/midpoint/reference/v1/misc/persona/[personas] to have the same password.
...
* xref:/midpoint/reference/v1/security/credentials/password-related-configuration/[Password-Related Configuration]