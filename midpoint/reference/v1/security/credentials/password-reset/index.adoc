...
To configure authentication for password reset, the xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration/[flexible authentication] feature needs to be used.
Flexible authentication configuration is part of the xref:/midpoint/reference/v1/security/security-policy/[security policy configuration].
...
| `userName`
| xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration.adoc#_focusIdentification[`focusIdentification`]
| Identify the user whose password is going to be reset.

| `passwordHint`
| xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration.adoc#_hint[`hint`]
| Give user a chance to recall the password by showing a password hint.

| `mailNonce`
| xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration.adoc#_mailNonce[`mailNonce`]
...
| `securityQuestionsForm`
| xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration.adoc#_securityQuestionsForm[`securityQuestionsForm`]
...
| xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration.adoc#_attributeVerification[`attributeVerification`]
...
Full list of xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration/#module-configuration[supported authentication modules] are listed in documentation for xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration/[Flexible authentication].
...
For such a configuration, please see section about xref:/midpoint/reference/v1/security/security-policy/#configuring-credentials[credentials policies configuration].
...
== See also
* xref:/midpoint/reference/v1/security/security-policy/[Security Policy]

* xref:/midpoint/reference/v1/security/credentials/password-policy/[Password Policy]

* xref:/midpoint/reference/v1/security/authentication/flexible-authentication/configuration/[Flexible Authentication]

* xref:/midpoint/reference/v1/misc/notifications/configuration/[Notifications Configuration]
