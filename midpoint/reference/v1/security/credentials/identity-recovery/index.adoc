...
processed with the help of xref:/midpoint/reference/v1/correlation/[correlation mechanism] and as a result one or multiple
...
xref:/midpoint/reference/v1/security/security-policy/[security policy merging] documentation.
...
about self registration flow configuration you can find by the xref:/midpoint/reference/v1/misc/self-registration/[link].
