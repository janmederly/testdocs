...
This is a simple tutorial describing the new xref:/midpoint/reference/v1/simulation/[simulation] feature.
...
NOTE: For more information about how to mark the shadows, please see xref:/midpoint/reference/v1/mark/#gui-object-marks-and-shadows[Object Marks].
...
In this tutorial, we showed how to use new xref:/midpoint/reference/v1/simulation/[simulations] feature to realize a simple scenario of connecting one source and one target resource.
