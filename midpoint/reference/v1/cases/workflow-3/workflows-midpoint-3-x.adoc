...
Embedded workflow engine was removed in midPoint 4.0 and midPoint is now completely xref:/midpoint/reference/v1/cases/workflowless/[workflowless]. If you still need manual processes as part of IDM interactions please see xref:/midpoint/reference/v1/cases/approval/policy-based-approvals/[Policy-based approvals] and xref:/midpoint/features/planned/external-workflow-integration/[Workflow Integration].
====
...
The workflows are usually used to implement xref:/midpoint/reference/v1/cases/approval/[approval] processes.
This usage is so frequent that midPoint has a special mechanisms to make approval implementation easy.
See the xref:/midpoint/reference/v1/cases/approval/[Approval] page for more details.
...
. xref:/midpoint/reference/v1/cases/approval/examples/[Approval examples]

. xref:/midpoint/reference/v1/cases/workflow-3/legacy-approvals-examples/[Approvals examples (legacy)]
...
. xref:/midpoint/reference/v1/cases/workflow-3/legacy-pre-3-5-workflow-configuration/[System manager's view on workflows (i.e. workflow configuration)]
