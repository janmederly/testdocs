...
. Other parts of configuration are stored in xref:/midpoint/reference/v1/concepts/system-configuration-object/[System Configuration] repository object.
...
For more information, see xref:/midpoint/reference/v1/cases/workflow-3/legacy-approvals-examples/[these examples].