...
For details see related section in https://docs.evolveum.com/midpoint/reference/v1/repository/native-postgresql/postgresql-configuration/#connections[PostgreSQL Configuration].
...
For more information how to set up task manager for a cluster, please see xref:/midpoint/reference/v1/deployment/clustering-ha/[this article].
