...
xref:/midpoint/reference/v1/tasks/activities/[here] for in-depth description.
...
1. New xref:/midpoint/reference/v1/tasks/auto-scaling/[auto-scaling activity] was created.
...
The xref:/midpoint/reference/v1/tasks/thresholds/[threshold mechanism] before 4.4 was limited to a single node.
