...
xref:/midpoint/reference/v1/synchronization/introduction/[synchronization] of midPoint objects.
...
[TIP]
====
All the synchronization tasks are using the same xref:/midpoint/reference/v1/synchronization/introduction/[synchronization mechanism].
See the xref:/midpoint/reference/v1/synchronization/introduction/[Synchronization] page for an introduction.

For all the synchronization tasks to work correctly the xref:/midpoint/reference/v1/resources/resource-configuration/synchronization/[synchronization section]
of xref:/midpoint/reference/v1/resources/resource-configuration/[resource configuration] must be set up properly.
See xref:/midpoint/reference/v1/resources/resource-configuration/synchronization/[Synchronization Configuration] page for more details.
====
...
xref:/midpoint/reference/v1/resources/shadow/kind-intent-objectclass/['object class, kind, and intent']
using xref:/midpoint/reference/v1/tasks/activities/resource-object-set-specification/[these settings].

=== MidPoint 4.4 and After

The resource objects are specified using xref:/midpoint/reference/v1/tasks/activities/resource-object-set-specification/[`resourceObjects`]
...
* xref:/midpoint/reference/v1/tasks/activities/[Activities]

* xref:/midpoint/reference/v1/tasks/recompute-task/[Recompute Task]
