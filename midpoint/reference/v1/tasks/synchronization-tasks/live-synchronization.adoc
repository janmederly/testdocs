...
The heart of the configuration is the specification of what xref:/midpoint/reference/v1/tasks/activities/resource-object-set-specification/[resource objects]
...
(See xref:/midpoint/reference/v1/resources/resource-configuration/capabilities/[]).
...
custom xref:/midpoint/reference/v1/tasks/task-error-handling/[error handling specification].
