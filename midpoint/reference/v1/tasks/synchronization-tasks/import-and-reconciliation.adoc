...
xref:/midpoint/reference/v1/tasks/activities/resource-object-set-specification/[resource objects] we want to process. We need to know
...
xref:/midpoint/reference/v1/tasks/activities/resource-object-set-specification/[here].
...
midPoint invokes the reaction defined for the "deleted" xref:/midpoint/reference/v1/synchronization/situations/[situation],
