...
:page-moved-from: /midpoint/reference/v1/synchronization/live-sync-error-handling-strategy/
...
xref:/midpoint/reference/v1/tasks/activities/object-set-specification/#_failed_objects_selector[failed objects selector]
