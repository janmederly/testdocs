...
See also xref:/midpoint/reference/v1/misc/bulk/variables/[Variables in bulk actions] for more information on using bulk actions with variables.
...
* xref:/midpoint/reference/v1/misc/bulk/variables/[Variables in bulk actions]

* xref:/midpoint/reference/v1/tasks/task-manager/[Task Manager]