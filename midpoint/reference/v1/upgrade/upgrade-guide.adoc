...
Use the xref:/midpoint/reference/v1/deployment/ninja/[`ninja`] tool to check for deprecated and removed functionality:
...
This directory is your xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[midPoint home directory].
...
Since version 4.4, separate versions for the xref:/midpoint/reference/v1/repository/native-postgresql/[Native repository]
and the xref:/midpoint/reference/v1/repository/generic/[Generic repository] are provided.

Database upgrade is thoroughly described in xref:/midpoint/reference/v1/upgrade/database-schema-upgrade[this document].
There are also deployment specific details to consider, e.g. is the audit in the same database?

For example, using the recommended xref:/midpoint/reference/v1/repository/native-postgresql/[Native repository]
...
Many midPoint releases bring new and updated xref:/midpoint/reference/v1/deployment/initial-objects/[initial objects].
...
* xref:/midpoint/reference/v1/upgrade/database-schema-upgrade/[Database Schema Upgrade]
