...
:page-alias: { "parent" : "/midpoint/reference/v1/misc/reports/", "slug" : "certification",  "title" : "Access Certification" }
...
Depending on the xref:/midpoint/reference/v1/roles-policies/certification/determining-case-outcome/[review strategy], some cases might be "stopped": they do not advance to next stage after being e.g. revoked in some (previous) stage.
