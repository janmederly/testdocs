...
The general idea of metarole-based configuration and the corresponding user interface is introduced on xref:/midpoint/reference/v1/roles-policies/applicable-policies/[User-Friendly Policy Selection] page.
...
See xref:/midpoint/reference/v1/roles-policies/metaroles/policy/[Using Metaroles for Policy Configuration] page for a more specific examples of approval policy specification in a metarole.
