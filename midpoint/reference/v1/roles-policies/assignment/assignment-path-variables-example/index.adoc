...
To better illustrate meaning of various xref:/midpoint/reference/v1/roles-policies/assignment/configuration/#construction-variables[assignment-related variables] let us present an example.
