...
The connector can be "deployed" to midPoint by placing the JAR file in directory `icf-connectors` in xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[midPoint home directory] and restarting midPoint.
...
* xref:/midpoint/reference/v1/resources/connid/[] will provide guidance how to use your new ConnId connector to midPoint.
...
See xref:/midpoint/reference/v1/upgrade/connectors/[Connector Upgrade].
====
...
. *Deploy the connector*. Just place the JAR file in the xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[MidPoint Home Directory] in the `icf-connectors` subdirectory.
...
If there are any new connectors in the xref:/midpoint/reference/v1/deployment/midpoint-home-directory/[MidPoint Home Directory], midPoint will create corresponding connector definitions for them.
...
This is the place that needs to be changed during xref:/midpoint/reference/v1/upgrade/connectors/[Connector Upgrade].
...
Please see xref:/midpoint/reference/v1/upgrade/connectors/[Connector Upgrade] page.

== See Also

* xref:/midpoint/reference/v1/resources/connid/[ConnId]

* xref:/midpoint/reference/v1/upgrade/connectors/[Connector Upgrade]

* xref:/connectors/connid/1.x/connector-server/[Connector Server]

* xref:/connectors/connid/1.x/connector-development-guide/[]

* xref:/midpoint/reference/v1/resources/connid/[]
