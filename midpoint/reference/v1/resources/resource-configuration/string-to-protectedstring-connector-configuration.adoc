...
The basic idea is to manually change the type of the configuration item in the xref:/midpoint/reference/v1/resources/resource-schema/explanation/[connector schema].
