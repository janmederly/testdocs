...
The `consistency` section of xref:/midpoint/reference/v1/resources/resource-configuration/[Resource Configuration] contains configuration of various data consistency mechanisms and features.
...
MidPoint usually operates in a xref:/midpoint/reference/v1/concepts/relativity/[relative] way.
