...
MidPoint usually keeps cached version of the account in midPoint xref:/midpoint/architecture/archive/subsystems/repo/[repository]. In fact the same mechanism that is used for xref:/midpoint/reference/v1/resources/attribute-caching/[attribute caching] is used here.
...
This is allowed by midPoint's unique xref:/midpoint/reference/v1/resources/multi-connector-resource/[multi-connector feature].
...
See xref:/midpoint/reference/v1/resources/propagation/[Provisioning Propagation] page for more details.


== Configuration

See xref:/midpoint/reference/v1/resources/manual/configuration/[Manual Resource Configuration] page for configuration details.
...
* xref:/midpoint/reference/v1/resources/manual/configuration/[Manual Resource Configuration]
