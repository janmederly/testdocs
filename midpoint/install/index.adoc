...
* xref:../quickstart/[*Quick Start* installation] describes the very essential steps to get midPoint running for evaluation purposes. test2

== See Also

* xref:../quickstart/[]
* xref:/midpoint/midscale/[test1]
* xref:/midpoint/support/subscription-sponsoring/[test2]
* xref:/midpoint/support/subscription\-sponsoring/[test3]
* xref:/midpoint/midscale/abcd/def/[test4]
