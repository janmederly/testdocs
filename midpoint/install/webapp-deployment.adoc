...
MidPoint primary deployment model is a xref:/midpoint/reference/latest/deployment/stand-alone-deployment/[stand-alone deployment] based on Spring Boot.
...
However, the xref:/midpoint/reference/latest/deployment/stand-alone-deployment/[stand-alone deployment] model is now the primary and recommended one.
The explicit deployment to a web container is deprecated.
The support may be removed soon.
Therefore, existing deployments that use this approach are advised to migrate to xref:/midpoint/reference/latest/deployment/stand-alone-deployment/[stand-alone deployment] as soon as possible.
====
...
This line sets up xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[MidPoint Home Directory] location, memory options and truststore location.
...
The xref:/midpoint/reference/latest/repository/configuration/[Repository Configuration] page provides the instructions.
