...
What may be interesting with the deployment is xref:/midpoint/reference/latest/security/authentication/flexible-authentication/configuration.adoc[Flexible authentication].
...
This example task utilizing xref:/midpoint/reference/latest/tasks/activities/index.adoc[Activities].
...
Specific information related to the connectors can be found on the dedicated xref:/midpoint/reference/latest/resources/connector-setup.adoc[Connector Setup] docs page.
