...
[NOTE]
In case you have persistent volume with already generated keystore the relevant steps are related just to xref:/midpoint/reference/latest/security/crypto/keystore-configuration.adoc#import-trusted-ca-certificate[import] the certificate to keystore.
