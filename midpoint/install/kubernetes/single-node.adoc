...
* xref:/midpoint/reference/latest/repository/generic/[Generic] (deprecated since 4.4)
* xref:/midpoint/reference/latest/repository/native-postgresql/[Native]
...
The name and content for the variables are related to the xref:/midpoint/reference/latest/repository/configuration/[Repository configuration].

=== Native

xref:/midpoint/reference/latest/repository/native-postgresql/[Native] repository came with midpoint 4.4.
