...
To this topic a dedicated xref:/midpoint/reference/latest/repository/native-postgresql/usage/[docs page] is available.
...
There is example with link:https://docs.evolveum.com/midpoint/reference/latest/deployment/post-initial-import/[post-initial-object].
