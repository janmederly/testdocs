...
* *Use activity in task (for midPoint 4.4 and above)*: the task will be created using xref:/midpoint/reference/latest/tasks/activities[activities] (midPoint 4.4 and above)
