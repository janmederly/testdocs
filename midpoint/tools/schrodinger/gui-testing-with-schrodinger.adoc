...
How the default is set is described on the following xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[page]. Can be changed using the argument* -Dmidpoint.home*
