...
Which means they can cause provisioning of accounts or other resource objects, they may contain other abstract roles, they can form a platform for xref:/midpoint/reference/latest/roles-policies/policy-rules/[Policy Rules] and so on.

In simple technical terms _abstract role_ means that the object may contain xref:/midpoint/reference/latest/roles-policies/assignment/assignment-vs-inducement/[inducement].
