...
Tasks are managed by xref:/midpoint/reference/latest/tasks/task-manager/[Task Manager] component.
...
See the xref:/midpoint/reference/latest/tasks/task-manager/[Task Manager] page for more details.
...
* xref:/midpoint/reference/latest/tasks/task-manager/[Task Manager]
