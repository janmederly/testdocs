...
UserType is also a xref:/midpoint/reference/latest/schema/focus-and-projections/[focal type]. Therefore it can behave as a "focus" (authoritative object) in midPoint xref:/midpoint/reference/latest/synchronization/introduction/[synchronization].
...
Please see xref:/midpoint/reference/latest/roles-policies/assignment/[Assignment] and xref:/midpoint/reference/latest/roles-policies/assignment/assigning-vs-linking/[Assigning vs Linking] pages.
