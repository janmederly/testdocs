...
All the object types are described inline in XSD schema files or you can access the formated documentation in xref:/midpoint/reference/latest/schema/schemadoc/[SchemaDoc] form.
