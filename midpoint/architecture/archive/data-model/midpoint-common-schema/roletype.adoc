...
RoleType is also a xref:/midpoint/reference/latest/schema/focus-and-projections/[focal type]. Therefore it can behave as a "focus" (authoritative object) in midPoint xref:/midpoint/reference/latest/synchronization/introduction/[synchronization]. If this mechanism is used to apply a role to another roles (or other non-user object) then it becomes a xref:/midpoint/reference/latest/roles-policies/metaroles/gensync/[meta-role].
...
| AssignmentType +
 optional, multi
| See xref:/midpoint/reference/latest/roles-policies/assignment/[Assignment] and xref:/midpoint/reference/latest/roles-policies/assignment/assignment-vs-inducement/[Assignment vs Inducement].
...
See xref:/midpoint/reference/latest/security/authorization/[Authorization]
