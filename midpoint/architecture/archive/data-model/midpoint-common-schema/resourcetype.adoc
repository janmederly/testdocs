...
See below and also xref:/midpoint/reference/latest/resources/resource-schema/[Resource Schema].
...
See xref:/midpoint/reference/latest/resources/resource-configuration/schema-handling/[Resource Schema Handling].
