...
See xref:/midpoint/reference/latest/org/organizational-structure/[Organizational Structure] page for general introduction to the concepts.
...
OrgType is also a xref:/midpoint/reference/latest/schema/focus-and-projections/[focal type].
Therefore it can behave as a "focus" (authoritative object) in midPoint xref:/midpoint/reference/latest/synchronization/introduction/[synchronization].
