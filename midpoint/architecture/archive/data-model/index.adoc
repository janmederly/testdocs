...
xref:/midpoint/reference/latest/concepts/data-representation-formats/[XML is not perfect], but it is currently the best choice.
...
See xref:/midpoint/reference/latest/concepts/data-representation-formats/['Objects, XML, JSON and others'] for more details.
...
* *xref:/midpoint/reference/latest/resources/resource-schema/[Resource Schema]* defines how resources (resource connectors, adapters, frameworks) present the information to the IDM system.
...
The processed documentation is available in a form of xref:/midpoint/reference/latest/schema/schemadoc/[SchemaDoc].
