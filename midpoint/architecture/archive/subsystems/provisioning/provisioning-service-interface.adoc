...
*Platform:* Java +
*Dependencies:*xref:/midpoint/reference/latest/schema/[Data Model] +
...
* Resource Object (from xref:/midpoint/reference/latest/resources/resource-schema/[Resource Schema])
