...
GUI subsystem, and especially the administration interface, is using all the objects of the xref:/midpoint/reference/latest/schema/[Data Model]. This includes dynamic interpretation of the xref:/midpoint/reference/latest/resources/resource-schema/[Resource Schema] and possibly other dynamic schemas.
