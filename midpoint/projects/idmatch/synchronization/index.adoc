...
The classification consists of determining xref:/midpoint/reference/latest/resources/shadow/kind-intent-objectclass/['_kind_, _intent_, and _tag_']
...
xref:/midpoint/reference/latest/synchronization/synchronization-sorter.adoc[_synchronization sorter_] is used.footnote:[The name of this component
