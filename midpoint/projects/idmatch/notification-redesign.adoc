...
** xref:/midpoint/reference/latest/misc/notifications/velocity/[Velocity templating] is already available,
...
There is also a xref:/midpoint/reference/latest/misc/notifications/#special-kinds-of-handlers[handler chain],
...
* xref:/midpoint/reference/latest/misc/notifications/[Notifications] and subpages: xref:/midpoint/reference/latest/misc/notifications/configuration/[Configuring Notifications], xref:/midpoint/reference/latest/misc/notifications/sending-custom-notifications/[Sending custom notifications HOWTO], xref:/midpoint/reference/latest/misc/notifications/general/[General notification - role assignment example], etc.
...
* xref:/midpoint/reference/latest/misc/notifications/task-notifications/[Task Notifications]

* xref:/midpoint/reference/latest/roles-policies/certification/notifications/[Access Certification Notifications]
** Mentioned as a possible timed action in xref:/midpoint/reference/latest/roles-policies/certification/escalation/[Escalation in Certification Campaigns]
** Similar for cases: xref:/midpoint/reference/latest/cases/escalation/[Escalation in Approval Processes]

* xref:/midpoint/reference/latest/cases/workflow-3/workflow-notifications/[Worfklow notifications] and briefly on various workflow pages (how up-to-date are those docs?)

* Mentioned in xref:/iam/iga/workflow/[IGA Capability: Identity Workflow Automation] (Identity Governance and Administration)

* Possible action in xref:/midpoint/reference/latest/misc/bulk/#actions[bulk actions], also
xref:/midpoint/reference/latest/misc/bulk/actions/[in experimental version for 4.2]

* xref:/midpoint/reference/latest/misc/self-registration/#email-notifications[Self-registration] has notifications, so does xref:/midpoint/reference/latest/security/credentials/password-reset/[Password Reset]

* xref:/midpoint/reference/latest/upgrade/migration-from-sun-idm/#notifications[Migration from Sun IdM]

* Mentioned in xref:/midpoint/devel/design/parallel-and-asynchronous-provisioning/[Parallel and Asynchronous Provisioning]

* xref:/midpoint/reference/latest/misc/notifications/sending-custom-notifications/[Sending Custom Notifications]
