...
See xref:/midpoint/reference/latest/correlation/[Smart Correlation] for more information.]
...
Please see xref:/midpoint/reference/latest/correlation/[Smart Correlation] for details on how to configure the correlation.
