...
* xref:/midpoint/reference/latest/expressions/expressions/[Expression] for background information on expression evaluation,
...
xref:/midpoint/reference/latest/synchronization/linked-objects/[linked objects] one can imagine a mapping that would
