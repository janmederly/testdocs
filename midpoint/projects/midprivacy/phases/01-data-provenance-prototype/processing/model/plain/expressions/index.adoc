...
See xref:/midpoint/reference/latest/expressions/expressions/[Expression] for background information.
...
Returns zero set with a single value obtained by resolving given xref:/midpoint/reference/latest/expressions/constants/[constant].
...
xref:/midpoint/reference/latest/expressions/mappings/#handling-multiple-values[Handling Multiple Values]
and xref:/midpoint/reference/latest/expressions/mappings/#absolute-script-evaluation-mode[Absolute Script Evaluation Mode]
...
xref:/midpoint/reference/latest/expressions/mappings/#relativity[Relativity] section on Mapping page.
