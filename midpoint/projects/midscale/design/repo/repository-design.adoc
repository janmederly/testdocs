...
See xref:/midpoint/reference/latest/repository/native-postgresql/design-and-implementation.adoc[Design and Implementation]
and xref:/midpoint/reference/latest/repository/native-postgresql/db-maintenance.adoc[DB maintenance] for current pages.
...
** xref:/midpoint/reference/latest/roles-policies/rbac/[Parametric roles]
...
See also image::/midpoint/reference/latest/repository/generic/midpoint-db-4.2.png[schema diagram for midPoint 4.2].
