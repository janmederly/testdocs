...
For more information, see xref:/midpoint/reference/latest/tasks/task-manager/configuration/[Task Manager Configuration article].
...
| 2
| Groups defined
a| . Set Execution group for *Task1* and *Task2* to *Node2* (see xref:/midpoint/reference/latest/tasks/node-sticky-tasks/[Node-sticky tasks HOWTO]) +
...
* Get yourself familiar with the concept of role-based GUI authorization, read xref:/midpoint/reference/latest/security/authorization/[Authorization] section from our wiki,
...
(see xref:/midpoint/reference/latest/cases/workflow-3/workflow-notifications/[Workflow notifications])
a| [source,xml]
...
.. Go to your midpoint home directory (if you have trouble locating it, please refer to xref:/midpoint/reference/latest/deployment/midpoint-home-directory/[MidPoint Home Directory]),
...
See also xref:/midpoint/reference/latest/diag/logging/log-levels/[Log Levels].
