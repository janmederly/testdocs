...
* Do not forget about appropriate xref:/midpoint/reference/latest/diag/logging/[logging].
...
If the interface is meant to be public it should be listed in xref:/midpoint/reference/latest/interfaces/[Interfaces] page.
