...
. MidPoint user (or support engineer) files a *bug report* in our issue tracking system (see xref:/midpoint/reference/latest/diag/creating-a-bug-report/[Creating a Bug Report])
...
Therefore it is important to create good xref:/midpoint/reference/latest/diag/creating-a-bug-report/[bug reports].
