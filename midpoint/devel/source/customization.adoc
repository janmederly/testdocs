...
Alternatively, you can reuse the final product and add more code to it using xref:/midpoint/reference/latest/deployment/maven-overlay-project/[overlay mechanism].
