...
| model-client/
|
| xref:/midpoint/reference/latest/legacy/soap-client/[Model Web Service Client], stand-alone library that can be used to access midPoint functionality remotely.
...
| ucf-impl-connid
|
| Implementation of xref:/midpoint/architecture/archive/subsystems/provisioning/ucf/[Unified Connector Framework] for the xref:/midpoint/reference/latest/resources/connid/[ConnId] framework.
...
| task-quartz-impl/
|
| xref:/midpoint/reference/latest/tasks/task-manager/[Task Manager] implementation based on Quartz library
...
| schema/
|
| Implementation of xref:/midpoint/reference/latest/schema/[Data Model]
...
|
| Sample data.
See xref:/midpoint/reference/latest/samples/[Configuration Samples]
