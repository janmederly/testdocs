...
See https://docs.evolveum.com/midpoint/reference/latest/resources/resource-configuration/schema-handling/changes-in-4.6/[the documentation] for more information.
