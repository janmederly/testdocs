...
Deltas are stored in a structure that is central to the model operation: the xref:/midpoint/reference/latest/concepts/clockwork/model-context/[Model Context].
