...
Such constraints are used as part of xref:/midpoint/reference/latest/roles-policies/policy-rules/[policy rules], where they serve as conditions determining whether the rule should be triggered or not.
