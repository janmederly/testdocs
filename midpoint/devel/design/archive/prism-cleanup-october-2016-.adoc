...
The new supported way of constructing search filters and object queries is now xref:/midpoint/reference/latest/concepts/query/#java-fluent-api[QueryBuilder API].
