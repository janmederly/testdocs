...
xref:/midpoint/reference/latest/schema/object-references/[Object References] are used in midPoint to refer from one object to another object.
...
See xref:/midpoint/reference/latest/schema/object-references/[Object References] page for more details.
