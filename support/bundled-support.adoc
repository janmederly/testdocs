...
* xref:/midpoint/reference/latest/legacy/eclipse-plugin/[MidPoint plugin for Eclipse IDE]

* xref:/midpoint/reference/latest/legacy/jaspersoft-studio/[MidPoint-specific integration for Jaspersoft Studio]
