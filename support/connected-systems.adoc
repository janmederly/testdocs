...
The same policy applies to all integrations, such as xref:/midpoint/reference/latest/resources/manual/itsm-plugin/[plugins for ITSM systems], asynchronous messaging integrations.
